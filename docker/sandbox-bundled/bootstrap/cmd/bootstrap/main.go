...
import (
	...
	"github.com/nebulaclouds/nebula/docker/sandbox-bundled/bootstrap/internal/transform"
	"github.com/nebulaclouds/nebula/docker/sandbox-bundled/bootstrap/internal/transform/plugins/config"
	"github.com/nebulaclouds/nebula/docker/sandbox-bundled/bootstrap/internal/transform/plugins/vars"
)

const (
	configDirPath                         = "/var/lib/nebula/config"
	configurationConfigMapName            = "nebula-sandbox-extra-config"
	clusterResourceTemplatesConfigMapName = "nebula-sandbox-extra-cluster-resource-templates"
	deploymentName                        = "nebula-sandbox"
	devModeEnvVar                         = "NEBULA_DEV"
	...
	renderedManifestPath  = "/var/lib/rancher/k3s/server/manifests/nebula.yaml"
)
