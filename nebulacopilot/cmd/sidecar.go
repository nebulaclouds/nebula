...
import (
	...
	"github.com/nebulaclouds/nebula/nebulacopilot/cmd/containerwatcher"
	"github.com/nebulaclouds/nebula/nebulacopilot/data"
...
func NewUploadCommand(opts *RootOptions) *cobra.Command {
	...
	uploadCmd := &cobra.Command{
		Use:   "sidecar <opts>",
		Short: "uploads nebulaData from the localpath to a remote dir.",
