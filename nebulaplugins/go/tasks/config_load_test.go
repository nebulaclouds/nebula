...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/plugins/k8s/spark"
...
func TestLoadConfig(t *testing.T) {
	...
	t.Run("k8s-config-test", func(t *testing.T) {
		...
		k8sConfig := nebulaK8sConfig.GetK8sPluginConfig()
		...
		assert.Equal(t, "x/nebula", k8sConfig.InterruptibleTolerations[0].Key)
