...
func init() {
	// TODO(katrogan): Once we move pluginmachinery to nebulaidl make these task types named constants that nebulaplugins
	// can reference in other handler definitions.
	// NOTE: these should match the constants defined nebulakit
