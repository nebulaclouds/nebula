...
func TestConvertToDNS1123CompatibleString(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "nebulakit-java task execution",
			args: args{"orgnebulaexamplesHelloWorldTask-0"},
			want: "orgnebulaexamples-hello-world-task-0",
		},
		{
			name: "good pod name",
...
func TestConvertCamelCaseToKebabCase(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "nebulakit-java task execution",
			args: args{"orgnebulaexamplesHelloWorldTask"},
			want: "orgnebulaexamples-hello-world-task",
		},
		{
			name: "good pod name",
			args: args{"t7vyqhzju1-fib-5-0"},
