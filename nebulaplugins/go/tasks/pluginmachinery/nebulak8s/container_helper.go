...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/errors"
...
func ApplyResourceOverrides(resources, platformResources v1.ResourceRequirements, assignIfUnset bool) v1.ResourceRequirements {
	...
	// As a fallback, in the case the Nebula workflow object does not have platformResource defaults set, the defaults
	...
	// TODO: Make configurable. 1/15/2019 Nebula Cluster doesn't support setting storage requests/limits.
...
// all Nebula configuration including k8s plugins and resource requests.
func ToK8sContainer(ctx context.Context, tCtx pluginscore.TaskExecutionContext) (*v1.Container, error) {
	...
	// add nebula resource customizations to the container
	...
	if err := AddNebulaCustomizationsToContainer(ctx, templateParameters, ResourceCustomizationModeMergeExistingResources, container); err != nil {
		return nil, err
	}
...
// AddNebulaCustomizationsToContainer takes a container definition which specifies how to run a Nebula task and fills in
...
func AddNebulaCustomizationsToContainer(ctx context.Context, parameters template.Parameters,
