...
// A Plugin Handle method returns a Transition. This transition indicates to the Nebula framework that if the plugin wants to continue "Handle"ing this task,
