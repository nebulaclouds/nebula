...
func (_m TaskOverrides_GetExtendedResources) Return(_a0 *nebulaidlcore.ExtendedResources) *TaskOverrides_GetExtendedResources {
...
func (_m *TaskOverrides) GetExtendedResources() *nebulaidlcore.ExtendedResources {
	ret := _m.Called()

	var r0 *nebulaidlcore.ExtendedResources
	if rf, ok := ret.Get(0).(func() *nebulaidlcore.ExtendedResources); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*nebulaidlcore.ExtendedResources)
		}
	}
