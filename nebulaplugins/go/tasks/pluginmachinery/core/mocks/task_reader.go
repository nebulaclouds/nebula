...
func (_m TaskReader_Read) Return(_a0 *nebulaidlcore.TaskTemplate, _a1 error) *TaskReader_Read {
...
func (_m *TaskReader) Read(ctx context.Context) (*nebulaidlcore.TaskTemplate, error) {
	ret := _m.Called(ctx)

	var r0 *nebulaidlcore.TaskTemplate
	if rf, ok := ret.Get(0).(func(context.Context) *nebulaidlcore.TaskTemplate); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*nebulaidlcore.TaskTemplate)
		}
	}
