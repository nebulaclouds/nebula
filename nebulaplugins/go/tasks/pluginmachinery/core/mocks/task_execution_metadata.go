...
func (_m TaskExecutionMetadata_GetSecurityContext) Return(_a0 nebulaidlcore.SecurityContext) *TaskExecutionMetadata_GetSecurityContext {
...
func (_m *TaskExecutionMetadata) GetSecurityContext() nebulaidlcore.SecurityContext {
	ret := _m.Called()

	var r0 nebulaidlcore.SecurityContext
	if rf, ok := ret.Get(0).(func() nebulaidlcore.SecurityContext); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(nebulaidlcore.SecurityContext)
	}
