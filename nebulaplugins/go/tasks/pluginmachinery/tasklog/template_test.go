...
func TestTemplateLogPlugin(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			"cloudwatch",
			TemplateLogPlugin{
				TemplateURIs:  []TemplateURI{"https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#logEventViewer:group=/nebula-production/kubernetes;stream=var.log.containers.{{.podName}}_{{.namespace}}_{{.containerName}}-{{.containerId}}.log"},
			...
			args{
				input: Input{
					...
					PodUID:               "pod-uid",
					Namespace:            "nebulaexamples-production",
			...
			Output{TaskLogs: []*core.TaskLog{{
				Uri:           "https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#logEventViewer:group=/nebula-production/kubernetes;stream=var.log.containers.f-uuid-driver_nebulaexamples-production_spark-kubernetes-driver-abc.log",
				MessageFormat: core.TaskLog_JSON,
				Name:          "main_logs",
			}}},
		},
		...
		},
		{
			...
			args{
				input: Input{
					PodName:              "nebulaexamples-development-task-name",
					PodUID:               "pod-uid",
					Namespace:            "nebulaexamples-development",
			...
			Output{TaskLogs: []*core.TaskLog{{
				Uri:           "https://dashboard.k8s.net/#!/log/nebulaexamples-development/nebulaexamples-development-task-name/pod?namespace=nebulaexamples-development",
				MessageFormat: core.TaskLog_JSON,
				Name:          "main_logs",
			}}},
		},
		...
		},
		{
			...
			TemplateLogPlugin{
				...
				TemplateURIs:  []TemplateURI{"https://nebula.corp.net/console/projects/{{ .executionProject }}/domains/{{ .executionDomain }}/executions/{{ .executionName }}/nodeId/{{ .nodeID }}/taskId/{{ .taskID }}/attempt/{{ .taskRetryAttempt }}/view/logs"},
				MessageFormat: core.TaskLog_JSON,
			},
			args{
				input: Input{
			...
			Output{
				TaskLogs: []*core.TaskLog{
					{
						Uri:           "https://nebula.corp.net/console/projects/my-execution-project/domains/my-execution-domain/executions/my-execution-name/nodeId/n0-0-n0/taskId/my-task-name/attempt/1/view/logs",
						MessageFormat: core.TaskLog_JSON,
						Name:          "main_logs",
					},
				},
		...
		},
		{
			...
			TemplateLogPlugin{
				Scheme:        TemplateSchemeTaskExecution,
				TemplateURIs:  []TemplateURI{"https://nebula.corp.net/console/projects/{{ .executionProject }}/domains/{{ .executionDomain }}/executions/{{ .executionName }}/nodeId/{{ .nodeID }}/taskId/{{ .taskID }}/attempt/{{ .subtaskParentRetryAttempt }}/mappedIndex/{{ .subtaskExecutionIndex }}/mappedAttempt/{{ .subtaskRetryAttempt }}/view/logs"},
				MessageFormat: core.TaskLog_JSON,
			},
			args{
				input: Input{
			...
			Output{
				TaskLogs: []*core.TaskLog{
					{
						Uri:           "https://nebula.corp.net/console/projects/my-execution-project/domains/my-execution-domain/executions/my-execution-name/nodeId/n0-0-n0/taskId/my-task-name/attempt/0/mappedIndex/1/mappedAttempt/1/view/logs",
						MessageFormat: core.TaskLog_JSON,
						Name:          "main_logs",
					},
				},
