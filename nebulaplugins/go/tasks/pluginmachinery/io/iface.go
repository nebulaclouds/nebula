...
type CheckpointPaths interface {
	...
	// The path is not accessible to Nebula backend and are stored in the users raw path
...
// As of 02/20/2020 Nebulakit generates this path randomly for S3. This structure proposes migration of this logic to
// NebulaPluginMachinery so that it can be used more universally outside of Nebulakit.
