...
const (
	// Keep these in-sync with nebulaAdmin @
	// https://github.com/nebulaclouds/nebulaadmin/blob/d1c61c34f62d8ee51964f47877802d070dfa9e98/pkg/manager/impl/execution_manager.go#L42-L43
