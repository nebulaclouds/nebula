...
import (
	...
	core2 "github.com/nebulaclouds/nebula/nebulaidl/gen/pb-go/nebulaidl/core"
	...
	"github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/workqueue"
	...
	stdmocks "github.com/nebulaclouds/nebula/nebulastdlib/storage/mocks"
)
...
func TestCheckSubTasksState(t *testing.T) {
	...
	t.Run("RunningLogLinksAndSubtaskIDs", func(t *testing.T) {
		...
		for i := 0; i < subtaskCount; i++ {
			...
			assert.Equal(t, fmt.Sprintf("https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#logStream:group=/kubernetes/nebula;prefix=var.log.containers.notfound-%d;streamFilter=typeLogStreamPrefix", i), logLinks[1].Uri)
		}
	})
