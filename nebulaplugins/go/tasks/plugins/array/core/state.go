...
import (
	...
	idlPlugins "github.com/nebulaclouds/nebula/nebulaidl/gen/pb-go/nebulaidl/plugins"
...
// of the Nebula platform can understand what's happening. That is, each possible state that our plugin state
