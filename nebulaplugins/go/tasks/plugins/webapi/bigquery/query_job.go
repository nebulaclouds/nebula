...
func getJobConfigurationQuery(custom *QueryJobConfig, inputs *nebulaIdlCore.LiteralMap) (*bigquery.JobConfigurationQuery, error) {
...
func getQueryParameters(literalMap map[string]*nebulaIdlCore.Literal) ([]*bigquery.QueryParameter, error) {
...
func getQueryParameter(literal *nebulaIdlCore.Literal) (*bigquery.QueryParameterType, *bigquery.QueryParameterValue, error) {
	if scalar := literal.GetScalar(); scalar != nil {
		if primitive := scalar.GetPrimitive(); primitive != nil {
			switch primitive.Value.(type) {
			case *nebulaIdlCore.Primitive_Integer:
			...
			case *nebulaIdlCore.Primitive_StringValue:
			...
			case *nebulaIdlCore.Primitive_FloatValue:
			...
			case *nebulaIdlCore.Primitive_Boolean:
