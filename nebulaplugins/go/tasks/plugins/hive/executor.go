...
// This is the name of this plugin effectively. In Nebula plugin configuration, use this string to enable this plugin.
...
const hiveTaskType = "hive" // This needs to match the type defined in Nebulakit constants.py
