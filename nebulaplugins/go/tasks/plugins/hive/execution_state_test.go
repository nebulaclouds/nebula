...
import (
	...
	pluginsCoreMocks "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/core/mocks"
	"github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/io"
	ioMock "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/io/mocks"
	"github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/plugins/hive/client"
	quboleMocks "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/plugins/hive/client/mocks"
	"github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/plugins/hive/config"
	mocks2 "github.com/nebulaclouds/nebula/nebulastdlib/cache/mocks"
...
func TestGetQueryInfo(t *testing.T) {
	...
	assert.Equal(t, []string{"nebula_plugin_test", "ns:test-namespace", "label-1:val1"}, tags)
...
func TestValidateQuboleHiveJob(t *testing.T) {
	hiveJob := plugins.QuboleHiveJob{
		...
		Tags:         []string{"nebula_plugin_test", "sample:label"},
		Query:        nil,
	}
