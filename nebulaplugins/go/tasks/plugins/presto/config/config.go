...
import (
	...
	pluginsConfig "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/config"
...
// correspond to a single user query. These means that in total, Nebula is able to work on
// 'PrestoConfig.RoutingGroups[routing_group_name].Limit' user queries at a time as configured in the
// configurations for the Presto plugin. This means means that at most, Nebula will be working on this
...
// cache's LRU nature before the Nebula propeller workers get a chance to update the status of these
// items.
...
var (
	defaultConfig = Config{
		...
		DefaultUser:         "nebula-default-user",
