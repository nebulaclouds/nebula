...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaadmin/pkg/clusterresource/mocks"
	"github.com/nebulaclouds/nebula/nebulaadmin/pkg/errors"
	execClusterMocks "github.com/nebulaclouds/nebula/nebulaadmin/pkg/executioncluster/mocks"
...
func TestGetCustomTemplateValues(t *testing.T) {
	adminDataProvider := mocks.NebulaAdminDataProvider{}
...
func TestGetCustomTemplateValues_NothingToOverride(t *testing.T) {
	...
	adminDataProvider.OnGetClusterResourceAttributesMatch(mock.Anything, proj, domain).Return(
		nil, errors.NewNebulaAdminError(codes.NotFound, "foo"))
	testController := controller{
		adminDataProvider: &adminDataProvider,
	}
			...
			args: args{
				...
				current: []byte(`{
									...
									"metadata": {
										...
										"selfLink": "/api/v1/namespaces/nebulaexamples",
			...
			args: args{
				...
				current: []byte(`{
								...
								"metadata": {
									...
									"selfLink": "/api/v1/namespaces/nebulaexamples/resourcequotas/project-quota",
			...
			args: args{
				...
				current: []byte(`{
							...
							"metadata": {
								...
								"selfLink": "/api/v1/namespaces/nebula/serviceaccounts/default",
