...
// Implementation of an interfaces.NebulaAdminDataProvider which fetches data using a nebulaadmin service client
...
func NewAdminServiceDataProvider(
	adminClient service.AdminServiceClient) interfaces.NebulaAdminDataProvider {
