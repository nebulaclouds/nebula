...
import (
	...
	repoMocks "github.com/nebulaclouds/nebula/nebulaadmin/pkg/repositories/mocks"
	...
	configMocks "github.com/nebulaclouds/nebula/nebulaadmin/pkg/runtime/mocks"
		...
		mockRepo.(*repoMocks.MockRepository).ProjectRepoIface = &repoMocks.MockProjectRepo{
			ListProjectsFunction: func(ctx context.Context, input repoInterfaces.ListResourceInput) ([]models.Project, error) {
				...
				return []models.Project{
					{
						Identifier: "nebulasnacks",
						State:      &activeProjectState,
					},
					{
						Identifier: "nebulaexamples",
						State:      &activeProjectState,
					},
				}, nil
			},
