...
func (g *GCPRemoteURL) splitURI(ctx context.Context, uri string) (GCPGCSObject, error) {
	...
	if scheme != gcsScheme {
		...
		return GCPGCSObject{}, errors.NewNebulaAdminErrorf(codes.InvalidArgument,
...
func (g *GCPRemoteURL) Get(ctx context.Context, uri string) (admin.UrlBlob, error) {
	...
	if err != nil {
		...
		return admin.UrlBlob{}, errors.NewNebulaAdminErrorf(codes.InvalidArgument, "invalid uri: %s", uri)
	}
	...
	if err != nil {
		...
		return admin.UrlBlob{}, errors.NewNebulaAdminErrorf(
