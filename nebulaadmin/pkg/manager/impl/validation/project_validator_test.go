...
func TestValidateProjectAndDomain(t *testing.T) {
	...
	mockRepo.ProjectRepo().(*repositoryMocks.MockProjectRepo).GetFunction = func(
		...
		assert.Equal(t, projectID, "nebula-project-id")
...
func TestValidateProjectAndDomainArchivedProject(t *testing.T) {
	...
	assert.EqualError(t, err,
		"project [nebula-project-id] is not active")
}
...
func TestValidateProjectAndDomainError(t *testing.T) {
	...
	err := ValidateProjectAndDomain(context.Background(), mockRepo, testutils.GetApplicationConfigWithDefaultDomains(),
		"nebula-project-id", "domain")
	assert.EqualError(t, err,
		"failed to validate that project [nebula-project-id] and domain [domain] are registered, err: [foo]")
}
...
func TestValidateProjectAndDomainNotFound(t *testing.T) {
	...
	err := ValidateProjectAndDomain(context.Background(), mockRepo, testutils.GetApplicationConfigWithDefaultDomains(),
		"nebula-project", "domain")
	assert.EqualError(t, err, "failed to validate that project [nebula-project] and domain [domain] are registered, err: [project [nebula-project] not found]")
}
...
func TestValidateProjectDb(t *testing.T) {
	...
	t.Run("base case", func(t *testing.T) {
		...
		err := ValidateProjectForUpdate(context.Background(), mockRepo, "nebula-project-id")
...
func TestValidateProjectExistsDb(t *testing.T) {
	...
	t.Run("base case", func(t *testing.T) {
		...
		err := ValidateProjectExists(context.Background(), mockRepo, "nebula-project-id")
