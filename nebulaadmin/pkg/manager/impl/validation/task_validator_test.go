...
func TestValidateTask(t *testing.T) {
	...
	assert.EqualError(t, err, "Requested CPU default [1536Mi] is greater than current limit set in the platform configuration [200m]. Please contact Nebula Admins to change these limits or consult the configuration")
...
func TestValidateTaskResources_LimitGreaterThanConfig(t *testing.T) {
	...
	assert.EqualError(t, err, "Requested CPU limit [1536Mi] is greater than current limit set in the platform configuration [1Gi]. Please contact Nebula Admins to change these limits or consult the configuration")
}
...
func TestValidateTaskResources_DefaultGreaterThanConfig(t *testing.T) {
	...
	assert.EqualError(t, err, "Requested CPU default [1536Mi] is greater than current limit set in the platform configuration [1Gi]. Please contact Nebula Admins to change these limits or consult the configuration")
}
...
func TestValidateTaskResources_GPULimitGreaterThanConfig(t *testing.T) {
	...
	assert.EqualError(t, err, "Requested GPU default [2] is greater than current limit set in the platform configuration [1]. Please contact Nebula Admins to change these limits or consult the configuration")
}
