...
import (
	...
	workflowengine "github.com/nebulaclouds/nebula/nebulaadmin/pkg/workflowengine/impl"
	...
	compiler "github.com/nebulaclouds/nebula/nebulapropeller/pkg/compiler/common"
...
func (w *WorkflowManager) setDefaults(request admin.WorkflowCreateRequest) (admin.WorkflowCreateRequest, error) {
	...
	if request.Id == nil {
		return request, errors.NewNebulaAdminError(codes.InvalidArgument, "missing identifier for WorkflowCreateRequest")
	}
...
func (w *WorkflowManager) getCompiledWorkflow(
	...
	if err != nil {
		return admin.WorkflowClosure{}, errors.NewNebulaAdminErrorf(codes.Internal,
...
func (w *WorkflowManager) CreateWorkflow(
	...
	} else if nebulaAdminError, ok := err.(errors.NebulaAdminError); !ok || nebulaAdminError.Code() != codes.NotFound {
