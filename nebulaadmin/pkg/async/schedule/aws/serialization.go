...
func SerializeScheduleWorkflowPayload(
	...
	if err != nil {
		return nil, errors.NewNebulaAdminErrorf(codes.InvalidArgument, "failed to marshall launch plan with err: %v", err)
	}
...
func DeserializeScheduleWorkflowPayload(payload []byte) (ScheduledWorkflowExecutionRequest, error) {
	...
	if err != nil {
		return ScheduledWorkflowExecutionRequest{}, errors.NewNebulaAdminErrorf(codes.InvalidArgument,
