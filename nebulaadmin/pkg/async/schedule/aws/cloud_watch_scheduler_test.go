...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaadmin/pkg/async/schedule/aws/mocks"
...
const testScheduleName = "nebula_16301494360130577061"
const testScheduleDescription = "Schedule for Project:project Domain:domain Name:name launch plan"

var expectedError = nebulaAdminErrors.NewNebulaAdminError(codes.Internal, "foo")
