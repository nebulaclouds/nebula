...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaadmin/pkg/async/notifications/mocks"
...
var testSubscriberMessage = map[string]interface{}{
	"Type":             "Notification",
	"MessageId":        "1-a-3-c",
	"TopicArn":         "arn:aws:sns:my-region:123:nebula-test-notifications",
	"Subject":          "nebulaidl.admin.EmailNotification",
	...
	"UnsubscribeURL":   "https://sns.my-region.amazonaws.com/sns:my-region:123:nebula-test-notifications:1-2-3-4-5",
}
