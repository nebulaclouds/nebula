...
const (
	cloudEventSource     = "https://github.com/nebulaclouds/nebulaadmin"
	cloudEventTypePrefix = "com.nebula.resource"
	jsonSchemaURLKey     = "jsonschemaurl"
	jsonSchemaURL        = "https://github.com/nebulaclouds/nebulaidl/blob/v0.24.14/jsonschema/workflow_execution.json"
)
