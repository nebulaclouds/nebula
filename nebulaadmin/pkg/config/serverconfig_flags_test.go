...
func TestServerConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_thirdPartyConfig.nebulaClient.clientId", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("thirdPartyConfig.nebulaClient.clientId", testValue)
			if vString, err := cmdFlags.GetString("thirdPartyConfig.nebulaClient.clientId"); err == nil {
				testDecodeJson_ServerConfig(t, fmt.Sprintf("%v", vString), &actual.DeprecatedThirdPartyConfig.NebulaClientConfig.ClientID)
	...
	t.Run("Test_thirdPartyConfig.nebulaClient.redirectUri", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("thirdPartyConfig.nebulaClient.redirectUri", testValue)
			if vString, err := cmdFlags.GetString("thirdPartyConfig.nebulaClient.redirectUri"); err == nil {
				testDecodeJson_ServerConfig(t, fmt.Sprintf("%v", vString), &actual.DeprecatedThirdPartyConfig.NebulaClientConfig.RedirectURI)
	...
	t.Run("Test_thirdPartyConfig.nebulaClient.scopes", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := join_ServerConfig(defaultServerConfig.DeprecatedThirdPartyConfig.NebulaClientConfig.Scopes, ",")

			cmdFlags.Set("thirdPartyConfig.nebulaClient.scopes", testValue)
			if vStringSlice, err := cmdFlags.GetStringSlice("thirdPartyConfig.nebulaClient.scopes"); err == nil {
				testDecodeRaw_ServerConfig(t, join_ServerConfig(vStringSlice, ","), &actual.DeprecatedThirdPartyConfig.NebulaClientConfig.Scopes)
	...
	t.Run("Test_thirdPartyConfig.nebulaClient.audience", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("thirdPartyConfig.nebulaClient.audience", testValue)
			if vString, err := cmdFlags.GetString("thirdPartyConfig.nebulaClient.audience"); err == nil {
				testDecodeJson_ServerConfig(t, fmt.Sprintf("%v", vString), &actual.DeprecatedThirdPartyConfig.NebulaClientConfig.Audience)
