...
// KubeClientConfig contains the configuration used by nebulaadmin to configure its internal Kubernetes Client.
...
type ServerSecurityOptions struct {
	...
	// These options are here to allow deployments where the Nebula UI (Console) is served from a different domain/port.
...
var defaultServerConfig = &ServerConfig{
	...
	Security: ServerSecurityOptions{
		AllowCors:      true,
		AllowedHeaders: []string{"Content-Type", "nebula-authorization"},
