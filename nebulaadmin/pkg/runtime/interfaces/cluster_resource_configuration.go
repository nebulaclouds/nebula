...
type ClusterResourceConfig struct {
	...
	*/
	...
	StandaloneDeployment bool                        `json:"standaloneDeployment" pflag:", Whether the cluster resource sync is running in a standalone deployment and should call nebulaadmin service endpoints"`
}
