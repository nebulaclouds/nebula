...
type ApplicationConfig struct {
	...
	// in Nebula Workflow CRDs created in the CreateExecution flow. The corresponding role value is defined in the
	...
	// Event version to be used for Nebula workflows
	...
	// Note that setting this setting to `true` effectively disabled all caching in Nebula as all executions launched
...
type EventSchedulerConfig struct {
	...
	NebulaSchedulerConfig *NebulaSchedulerConfig `json:"local"`
}
...
func (e *EventSchedulerConfig) GetNebulaSchedulerConfig() *NebulaSchedulerConfig {
	return e.NebulaSchedulerConfig
}
...
// NebulaSchedulerConfig is the config for native or default nebula scheduler
type NebulaSchedulerConfig struct {
}
...
type WorkflowExecutorConfig struct {
	...
	NebulaWorkflowExecutorConfig *NebulaWorkflowExecutorConfig `json:"local"`
}
...
func (w *WorkflowExecutorConfig) GetNebulaWorkflowExecutorConfig() *NebulaWorkflowExecutorConfig {
	return w.NebulaWorkflowExecutorConfig
}
...
// NebulaWorkflowExecutorConfig specifies the workflow executor configuration for the native nebula scheduler
type NebulaWorkflowExecutorConfig struct {
...
func (f *NebulaWorkflowExecutorConfig) GetAdminRateLimit() *AdminRateLimit {
	return f.AdminRateLimit
}

func (f *NebulaWorkflowExecutorConfig) GetUseUTCTz() bool {
	return f.UseUTCTz
}
...
// Defines the interface to return top-level config structs necessary to start up a nebulaadmin application.
