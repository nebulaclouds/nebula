...
var nebulaAdminConfig = config.MustRegisterSection(nebulaAdmin, &interfaces.ApplicationConfig{
...
var schedulerConfig = config.MustRegisterSection(scheduler, &interfaces.SchedulerConfig{
	...
	EventSchedulerConfig: interfaces.EventSchedulerConfig{
		Scheme:               common.Local,
		NebulaSchedulerConfig: &interfaces.NebulaSchedulerConfig{},
	},
	WorkflowExecutorConfig: interfaces.WorkflowExecutorConfig{
		Scheme: common.Local,
		NebulaWorkflowExecutorConfig: &interfaces.NebulaWorkflowExecutorConfig{
...
func (p *ApplicationConfigurationProvider) GetTopLevelConfig() *interfaces.ApplicationConfig {
	return nebulaAdminConfig.GetConfig().(*interfaces.ApplicationConfig)
}
