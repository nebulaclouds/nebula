...
func TestIsInvalidDBPgError(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			Err:            &wrappedError{&pgconn.PgError{Severity: "FATAL", Message: "database \"nebula\" does not exist", Code: "3D000"}},
			ExpectedResult: true,
		},
	}
...
func TestIsPgDbAlreadyExistsError(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			Err:            &wrappedError{&pgconn.PgError{Severity: "FATAL", Message: "database \"nebula\" does not exist", Code: "42P04"}},
			ExpectedResult: true,
		},
	}
