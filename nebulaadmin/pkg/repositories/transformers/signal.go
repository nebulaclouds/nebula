...
func CreateSignalModel(signalID *core.SignalIdentifier, signalType *core.LiteralType, signalValue *core.Literal) (models.Signal, error) {
	...
	if signalType != nil {
		...
		if err != nil {
			return models.Signal{}, errors.NewNebulaAdminError(codes.Internal, "Failed to serialize signal type")
		}
	...
	if signalValue != nil {
		...
		if err != nil {
			return models.Signal{}, errors.NewNebulaAdminError(codes.Internal, "Failed to serialize signal value")
		}
...
func FromSignalModel(signalModel models.Signal) (admin.Signal, error) {
	...
	if len(signalModel.Type) > 0 {
		...
		if err != nil {
			return admin.Signal{}, errors.NewNebulaAdminError(codes.Internal, "failed to unmarshal signal type")
		}
	...
	if len(signalModel.Value) > 0 {
		...
		if err != nil {
			return admin.Signal{}, errors.NewNebulaAdminError(codes.Internal, "failed to unmarshal signal value")
		}
