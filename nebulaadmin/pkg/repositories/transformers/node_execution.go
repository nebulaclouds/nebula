...
func addNodeRunningState(request *admin.NodeExecutionEventRequest, nodeExecutionModel *models.NodeExecution,
	...
	if err != nil {
		return errors.NewNebulaAdminErrorf(codes.Internal, "failed to unmarshal occurredAt with error: %v", err)
	}
...
func addTerminalState(
	...
	if closure.StartedAt == nil {
		...
		if err != nil {
			return errors.NewNebulaAdminErrorf(
...
func CreateNodeExecutionModel(ctx context.Context, input ToNodeExecutionModelInput) (*models.NodeExecution, error) {
	...
	if err != nil {
		return nil, errors.NewNebulaAdminErrorf(codes.Internal, "failed to read event timestamp")
	}
	nodeExecution.NodeExecutionCreatedAt = &nodeExecutionCreatedAt
	nodeExecutionUpdatedAt, err := ptypes.Timestamp(reportedAt)
	if err != nil {
		return nil, errors.NewNebulaAdminErrorf(codes.Internal, "failed to read event reported_at timestamp")
	}
	...
	if err != nil {
		return nil, errors.NewNebulaAdminErrorf(codes.Internal, "failed to marshal node execution data with err: %v", err)
	}
...
func UpdateNodeExecutionModel(
	...
	if err != nil {
		return errors.NewNebulaAdminErrorf(codes.Internal, "failed to parse updated at timestamp")
	}
...
func FromNodeExecutionModel(nodeExecutionModel models.NodeExecution, opts *ExecutionTransformerOptions) (*admin.NodeExecution, error) {
	...
	if err != nil {
		return nil, errors.NewNebulaAdminErrorf(codes.Internal, "failed to unmarshal closure")
	}
	...
	if err != nil {
		return nil, errors.NewNebulaAdminErrorf(codes.Internal, "failed to unmarshal nodeExecutionMetadata")
	}
...
func GetNodeExecutionInternalData(internalData []byte) (*genModel.NodeExecutionInternalData, error) {
	...
	if len(internalData) > 0 {
		...
		if err != nil {
			return nil, errors.NewNebulaAdminErrorf(codes.Internal, "failed to unmarshal node execution data: %v", err)
		}
	}
