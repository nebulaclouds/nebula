...
func (r *ExecutionRepo) Get(ctx context.Context, input interfaces.Identifier) (models.Execution, error) {
	...
	if tx.Error != nil && errors.Is(tx.Error, gorm.ErrRecordNotFound) {
		...
		return models.Execution{}, r.errorTransformer.ToNebulaAdminError(tx.Error)
	}
...
func (r *ExecutionRepo) List(ctx context.Context, input interfaces.ListResourceInput) (
	...
	timer.Stop()
	if tx.Error != nil {
		return interfaces.ExecutionCollectionOutput{}, r.errorTransformer.ToNebulaAdminError(tx.Error)
	}
