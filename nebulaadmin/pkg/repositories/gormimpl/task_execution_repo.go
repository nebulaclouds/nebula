...
func (r *TaskExecutionRepo) Get(ctx context.Context, input interfaces.GetTaskExecutionInput) (models.TaskExecution, error) {
	...
	if tx.Error != nil && errors.Is(tx.Error, gorm.ErrRecordNotFound) {
		return models.TaskExecution{},
			nebulaAdminDbErrors.GetMissingEntityError("task execution", &core.TaskExecutionIdentifier{
		...
		return models.TaskExecution{}, r.errorTransformer.ToNebulaAdminError(tx.Error)
	}
...
func (r *TaskExecutionRepo) List(ctx context.Context, input interfaces.ListResourceInput) (interfaces.TaskExecutionCollectionOutput, error) {
	...
	timer.Stop()
	if tx.Error != nil {
		return interfaces.TaskExecutionCollectionOutput{}, r.errorTransformer.ToNebulaAdminError(tx.Error)
	}
...
func NewTaskExecutionRepo(
	db *gorm.DB, errorTransformer nebulaAdminDbErrors.ErrorTransformer, scope promutils.Scope) interfaces.TaskExecutionRepoInterface {
