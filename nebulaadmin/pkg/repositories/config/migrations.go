...
import (
	...
	schedulerModels "github.com/nebulaclouds/nebula/nebulaadmin/scheduler/repositories/models"
	...
	},
	{
		...
		Migrate: func(tx *gorm.DB) error {
			...
			type NodeExecution struct {
				...
				// Metadata that is only relevant to the nebulaadmin service that is used to parse the model and track additional attributes.
				InternalData          []byte
...

	{
		...
		Migrate: func(tx *gorm.DB) error {
			...
			type Resource struct {
				...
				// Serialized nebulaidl.admin.MatchingAttributes.
				Attributes []byte
			}
