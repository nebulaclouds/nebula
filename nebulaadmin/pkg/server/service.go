...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaadmin/auth/authzserver"
	authConfig "github.com/nebulaclouds/nebula/nebulaadmin/auth/config"
	"github.com/nebulaclouds/nebula/nebulaadmin/auth/interfaces"
	"github.com/nebulaclouds/nebula/nebulaadmin/dataproxy"
	"github.com/nebulaclouds/nebula/nebulaadmin/pkg/common"
	"github.com/nebulaclouds/nebula/nebulaadmin/pkg/config"
	"github.com/nebulaclouds/nebula/nebulaadmin/pkg/rpc"
	"github.com/nebulaclouds/nebula/nebulaadmin/pkg/rpc/adminservice"
	runtime2 "github.com/nebulaclouds/nebula/nebulaadmin/pkg/runtime"
...
func newGRPCServer(ctx context.Context, pluginRegistry *plugins.Registry, cfg *config.ServerConfig,
	...
	healthServer.SetServingStatus("nebulaadmin", grpc_health_v1.HealthCheckResponse_SERVING)
...
func serveGatewayInsecure(ctx context.Context, pluginRegistry *plugins.Registry, cfg *config.ServerConfig,
	...
	logger.Infof(ctx, "Serving Nebula Admin Insecure")
