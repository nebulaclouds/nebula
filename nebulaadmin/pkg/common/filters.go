...
func GetUnrecognizedFilterFunctionErr(function string) error {
	return errors.NewNebulaAdminErrorf(codes.InvalidArgument, unrecognizedFilterFunction,
		function)
}

func GetUnsupportedFilterExpressionErr(expression FilterExpression) error {
	return errors.NewNebulaAdminErrorf(codes.InvalidArgument, unsupportedFilterExpression,
		getFilterExpressionName(expression))
}

func GetInvalidSingleValueFilterErr(expression FilterExpression) error {
	return errors.NewNebulaAdminErrorf(codes.InvalidArgument, invalidSingleValueFilter,
		getFilterExpressionName(expression))
}

func GetInvalidRepeatedValueFilterErr(expression FilterExpression) error {
	return errors.NewNebulaAdminErrorf(codes.InvalidArgument, invalidRepeatedValueFilter,
		getFilterExpressionName(expression))
}
