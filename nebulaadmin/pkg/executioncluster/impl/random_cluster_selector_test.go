...
import (
	...
	interfaces2 "github.com/nebulaclouds/nebula/nebulaadmin/pkg/executioncluster/interfaces"
	"github.com/nebulaclouds/nebula/nebulaadmin/pkg/executioncluster/mocks"
	repo_interface "github.com/nebulaclouds/nebula/nebulaadmin/pkg/repositories/interfaces"
	repo_mock "github.com/nebulaclouds/nebula/nebulaadmin/pkg/repositories/mocks"
...
func getRandomClusterSelectorForTest(t *testing.T) interfaces2.ClusterInterface {
	...
	db.ResourceRepo().(*repo_mock.MockResourceRepo).GetFunction = func(ctx context.Context, ID repo_interface.ResourceID) (resource models.Resource, e error) {
		...
		if ID.Project == "" {
			return models.Resource{}, errors.NewNebulaAdminErrorf(codes.NotFound,
