module github.com/nebulaclouds/nebula/nebulaadmin
...
// Retracted versions
// This was published in error when attempting to create 1.5.1 Nebula release.
retract v1.1.94

replace (
	github.com/nebulaclouds/nebula/datacatalog => ../datacatalog
	github.com/nebulaclouds/nebula/nebulaadmin => ../nebulaadmin
	github.com/nebulaclouds/nebula/nebulaidl => ../nebulaidl
