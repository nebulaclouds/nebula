...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaadmin/scheduler/core"
	"github.com/nebulaclouds/nebula/nebulaadmin/scheduler/executor"
	...
	"github.com/nebulaclouds/nebula/nebulastdlib/futures"
...
// ScheduledExecutor used for executing the schedules saved by the native nebula scheduler in the database.
type ScheduledExecutor struct {
	...
	workflowExecutorConfig *runtimeInterfaces.NebulaWorkflowExecutorConfig
}

func (w *ScheduledExecutor) Run(ctx context.Context) error {
	logger.Infof(ctx, "Nebula native scheduler started successfully")

	defer logger.Infof(ctx, "Nebula native scheduler shutdown")
...
func NewScheduledExecutor(db repositoryInterfaces.SchedulerRepoInterface,
	...
	return ScheduledExecutor{
		...
		workflowExecutorConfig: workflowExecutorConfig.GetNebulaWorkflowExecutorConfig(),
