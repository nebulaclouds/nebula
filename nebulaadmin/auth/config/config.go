...
type OAuth2Options struct {
	...
	ThirdParty ThirdPartyConfigOptions `json:"thirdPartyConfig" pflag:",Defines settings to instruct nebula cli tools (and optionally others) on what config to use to setup their client."`
}
