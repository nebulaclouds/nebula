...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_appAuth.thirdPartyConfig.nebulaClient.clientId", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("appAuth.thirdPartyConfig.nebulaClient.clientId", testValue)
			if vString, err := cmdFlags.GetString("appAuth.thirdPartyConfig.nebulaClient.clientId"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.AppAuth.ThirdParty.NebulaClientConfig.ClientID)
	...
	t.Run("Test_appAuth.thirdPartyConfig.nebulaClient.redirectUri", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("appAuth.thirdPartyConfig.nebulaClient.redirectUri", testValue)
			if vString, err := cmdFlags.GetString("appAuth.thirdPartyConfig.nebulaClient.redirectUri"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.AppAuth.ThirdParty.NebulaClientConfig.RedirectURI)
	...
	t.Run("Test_appAuth.thirdPartyConfig.nebulaClient.scopes", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := join_Config(DefaultConfig.AppAuth.ThirdParty.NebulaClientConfig.Scopes, ",")

			cmdFlags.Set("appAuth.thirdPartyConfig.nebulaClient.scopes", testValue)
			if vStringSlice, err := cmdFlags.GetStringSlice("appAuth.thirdPartyConfig.nebulaClient.scopes"); err == nil {
				testDecodeRaw_Config(t, join_Config(vStringSlice, ","), &actual.AppAuth.ThirdParty.NebulaClientConfig.Scopes)
	...
	t.Run("Test_appAuth.thirdPartyConfig.nebulaClient.audience", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("appAuth.thirdPartyConfig.nebulaClient.audience", testValue)
			if vString, err := cmdFlags.GetString("appAuth.thirdPartyConfig.nebulaClient.audience"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.AppAuth.ThirdParty.NebulaClientConfig.Audience)
