...
const (
	// #nosec
	accessTokenCookieName = "nebula_at"
	// #nosec
	idTokenCookieName = "nebula_idt"
	// #nosec
	refreshTokenCookieName = "nebula_rt"
	// #nosec
	csrfStateCookieName = "nebula_csrf_state"
	// #nosec
	redirectURLCookieName = "nebula_redirect_location"

	// #nosec
	idTokenExtra = "id_token"

	// #nosec
	authCodeCookieName = "nebula_auth_code"

	// #nosec
	userInfoCookieName = "nebula_user_info"
)
