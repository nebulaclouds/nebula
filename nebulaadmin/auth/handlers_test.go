...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaadmin/auth/interfaces/mocks"
	...
	stdConfig "github.com/nebulaclouds/nebula/nebulastdlib/config"
)
...
func TestGetLoginHandler(t *testing.T) {
	...
	assert.True(t, strings.Contains(w.Header().Get("Set-Cookie"), "nebula_csrf_state="))
}
