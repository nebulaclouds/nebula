...
func testListLaunchPlansFilterOnScheduleHTTP(t *testing.T) {
	...
	queryStr = getLaunchPlanHTTPQueryStringWithFilter(
		"nebulakit", "development", "", "eq(schedule_type,NONE)")
	testOneListLaunchPlanHTTPGetRequest(t, queryStr, 0)

	queryStr = getLaunchPlanHTTPQueryStringWithFilter(
		"nebulakit", "development", "", "eq(schedule_type,CRON)")
	testOneListLaunchPlanHTTPGetRequest(t, queryStr, 0)

	queryStr = getLaunchPlanHTTPQueryStringWithFilter(
		"nebulakit", "development", "", "eq(schedule_type,RATE)")
	testOneListLaunchPlanHTTPGetRequest(t, queryStr, 1)
}
...
func testListLaunchPlansWithActiveScheduleHTTP(t *testing.T) {
	...
	queryStr = getLaunchPlanHTTPQueryStringWithFilter(
		"nebulakit", "development", "", "eq(schedule_type,NONE)+ne(state,1)")
	testOneListLaunchPlanHTTPGetRequest(t, queryStr, 0)

	queryStr = getLaunchPlanHTTPQueryStringWithFilter(
		"nebulakit", "development", "", "eq(schedule_type,CRON)+eq(state,1)")
	testOneListLaunchPlanHTTPGetRequest(t, queryStr, 0)

	queryStr = getLaunchPlanHTTPQueryStringWithFilter(
		"nebulakit", "development", "", "eq(schedule_type,RATE)+eq(state,1)")
	testOneListLaunchPlanHTTPGetRequest(t, queryStr, 1)
