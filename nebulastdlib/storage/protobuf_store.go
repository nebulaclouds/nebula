...
func (s DefaultProtobufStore) ReadProtobuf(ctx context.Context, reference DataReference, msg proto.Message) error {
	ctx, span := otelutils.NewSpan(ctx, otelutils.BlobstoreClientTracer, "nebulastdlib.storage.DefaultProtobufStore/ReadProtobuf")
	defer span.End()
...
func (s DefaultProtobufStore) WriteProtobuf(ctx context.Context, reference DataReference, opts Options, msg proto.Message) error {
	ctx, span := otelutils.NewSpan(ctx, otelutils.BlobstoreClientTracer, "nebulastdlib.storage.DefaultProtobufStore/WriteProtobuf")
	defer span.End()
