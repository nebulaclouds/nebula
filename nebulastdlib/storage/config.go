...
type SignedURLConfig struct {
	StowConfigOverride map[string]string `json:"stowConfigOverride,omitempty" pflag:"-,Configuration for stow backend. Refer to github/nebulaclouds/stow"`
}
...
// StowConfig defines configs for stow as defined in github.com/nebulaclouds/stow
type StowConfig struct {
	Kind   string            `json:"kind,omitempty" pflag:",Kind of Stow backend to use. Refer to github/nebulaclouds/stow"`
	Config map[string]string `json:"config,omitempty" pflag:",Configuration for stow backend. Refer to github/nebulaclouds/stow"`
}
