...
func TestBuilder(t *testing.T) {
	...
	k8sResolver, err := builder.Build(parseTarget("test://nebulaagent.nebula.svc.cluster.local:8000"), fc, resolver.BuildOptions{})
	if err != nil {
		t.Fatal(err)
	}
	...
	_, err = k8sClient.CoreV1().Endpoints("nebula").Create(context.Background(), &v1.Endpoints{
