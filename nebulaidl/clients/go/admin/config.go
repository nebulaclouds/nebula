// Initializes an Admin Client that exposes all implemented services by NebulaAdmin server. The library supports different
...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaidl/clients/go/admin/deviceflow"
	"github.com/nebulaclouds/nebula/nebulaidl/clients/go/admin/pkce"
...
const (
	...
	DefaultClientID  = "nebulapropeller"
)
...
type Config struct {
	...
	TokenURL string `json:"tokenUrl" pflag:",OPTIONAL: Your IdP's token endpoint. It'll be discovered from nebula admin's OAuth Metadata endpoint if not provided."`

	// See the implementation of the 'grpcAuthorizationHeader' option in Nebula Admin for more information. But
