...
//go:generate mockery -dir ../../../gen/pb-go/nebulaidl/service -name AdminServiceClient -output ../admin/mocks
...
// This retrieves a DialOption that contains a source for generating JWTs for authentication with Nebula Admin. If
