...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaidl/clients/go/admin/externalprocess"
...
// Returns the token source which would be used for three legged oauth. eg : for admin to authorize access to nebulactl
