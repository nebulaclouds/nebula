...
pub struct TaskExecutionEvent {
    ...
    /// A predefined yet extensible Task type identifier. If the task definition is already registered in nebula admin
...
pub mod task_execution_metadata {
    ...
    pub enum InstanceClass {
        /// The default instance class configured for the nebula application platform.
        Default = 0,
