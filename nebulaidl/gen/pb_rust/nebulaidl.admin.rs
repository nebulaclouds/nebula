...
pub struct WorkflowExecutionGetMetricsRequest {
    ...
    #[prost(message, optional, tag="1")]
    pub id: ::core::option::Option<super::core::WorkflowExecutionIdentifier>,
    /// depth defines the number of Nebula entity levels to traverse when breaking down execution details.
    #[prost(int32, tag="2")]
    pub depth: i32,
}
...
pub struct WorkflowExecutionGetMetricsResponse {
    ...
    /// hierarchical structure using Nebula entity references.
    #[prost(message, optional, tag="1")]
...
pub struct NodeExecutionGetDataResponse {
    ...
    #[prost(message, optional, tag="17")]
    pub nebula_urls: ::core::option::Option<NebulaUrLs>,
}
