...
const (
	...
	RuntimeMetadata_NEBULA_SDK RuntimeMetadata_RuntimeType = 1
)
...
func (RuntimeMetadata_RuntimeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bd8423ba58d6ed80, []int{3, 0}
}
...
type Resources_ResourceEntry struct {
	// Resource name.
	Name Resources_ResourceName `protobuf:"varint,1,opt,name=name,proto3,enum=nebulaidl.core.Resources_ResourceName" json:"name,omitempty"`
...
func (m *ExtendedResources) Reset()         { *m = ExtendedResources{} }
func (m *ExtendedResources) String() string { return proto.CompactTextString(m) }
...
func (m *ExtendedResources) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExtendedResources.Unmarshal(m, b)
}
func (m *ExtendedResources) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExtendedResources.Marshal(b, m, deterministic)
}
func (m *ExtendedResources) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExtendedResources.Merge(m, src)
}
func (m *ExtendedResources) XXX_Size() int {
	return xxx_messageInfo_ExtendedResources.Size(m)
}
func (m *ExtendedResources) XXX_DiscardUnknown() {
	xxx_messageInfo_ExtendedResources.DiscardUnknown(m)
}

var xxx_messageInfo_ExtendedResources proto.InternalMessageInfo

func (m *ExtendedResources) GetGpuAccelerator() *GPUAccelerator {
	if m != nil {
		return m.GpuAccelerator
	}
	return nil
}
...
type RuntimeMetadata struct {
	// Type of runtime.
	Type RuntimeMetadata_RuntimeType `protobuf:"varint,1,opt,name=type,proto3,enum=nebulaidl.core.RuntimeMetadata_RuntimeType" json:"type,omitempty"`
...
type Container struct {
	...
	Architecture         Container_Architecture `protobuf:"varint,10,opt,name=architecture,proto3,enum=nebulaidl.core.Container_Architecture" json:"architecture,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
type IOStrategy struct {
	...
	DownloadMode IOStrategy_DownloadMode `protobuf:"varint,1,opt,name=download_mode,json=downloadMode,proto3,enum=nebulaidl.core.IOStrategy_DownloadMode" json:"download_mode,omitempty"`
	// Mode to use to manage uploads
	UploadMode           IOStrategy_UploadMode `protobuf:"varint,2,opt,name=upload_mode,json=uploadMode,proto3,enum=nebulaidl.core.IOStrategy_UploadMode" json:"upload_mode,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
type DataLoadingConfig struct {
	...
	Format               DataLoadingConfig_LiteralMapFormat `protobuf:"varint,4,opt,name=format,proto3,enum=nebulaidl.core.DataLoadingConfig_LiteralMapFormat" json:"format,omitempty"`
...
type Sql struct {
	...
	Dialect              Sql_Dialect `protobuf:"varint,2,opt,name=dialect,proto3,enum=nebulaidl.core.Sql_Dialect" json:"dialect,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func init() {
	proto.RegisterEnum("nebulaidl.core.Resources_ResourceName", Resources_ResourceName_name, Resources_ResourceName_value)
	proto.RegisterEnum("nebulaidl.core.RuntimeMetadata_RuntimeType", RuntimeMetadata_RuntimeType_name, RuntimeMetadata_RuntimeType_value)
	proto.RegisterEnum("nebulaidl.core.Container_Architecture", Container_Architecture_name, Container_Architecture_value)
	proto.RegisterEnum("nebulaidl.core.IOStrategy_DownloadMode", IOStrategy_DownloadMode_name, IOStrategy_DownloadMode_value)
	proto.RegisterEnum("nebulaidl.core.IOStrategy_UploadMode", IOStrategy_UploadMode_name, IOStrategy_UploadMode_value)
	proto.RegisterEnum("nebulaidl.core.DataLoadingConfig_LiteralMapFormat", DataLoadingConfig_LiteralMapFormat_name, DataLoadingConfig_LiteralMapFormat_value)
	proto.RegisterEnum("nebulaidl.core.Sql_Dialect", Sql_Dialect_name, Sql_Dialect_value)
	proto.RegisterType((*Resources)(nil), "nebulaidl.core.Resources")
	proto.RegisterType((*Resources_ResourceEntry)(nil), "nebulaidl.core.Resources.ResourceEntry")
	proto.RegisterType((*GPUAccelerator)(nil), "nebulaidl.core.GPUAccelerator")
	proto.RegisterType((*ExtendedResources)(nil), "nebulaidl.core.ExtendedResources")
	proto.RegisterType((*RuntimeMetadata)(nil), "nebulaidl.core.RuntimeMetadata")
	proto.RegisterType((*TaskMetadata)(nil), "nebulaidl.core.TaskMetadata")
	proto.RegisterMapType((map[string]string)(nil), "nebulaidl.core.TaskMetadata.TagsEntry")
	proto.RegisterType((*TaskTemplate)(nil), "nebulaidl.core.TaskTemplate")
	proto.RegisterMapType((map[string]string)(nil), "nebulaidl.core.TaskTemplate.ConfigEntry")
	proto.RegisterType((*ContainerPort)(nil), "nebulaidl.core.ContainerPort")
	proto.RegisterType((*Container)(nil), "nebulaidl.core.Container")
	proto.RegisterType((*IOStrategy)(nil), "nebulaidl.core.IOStrategy")
	proto.RegisterType((*DataLoadingConfig)(nil), "nebulaidl.core.DataLoadingConfig")
	proto.RegisterType((*K8SPod)(nil), "nebulaidl.core.K8sPod")
	proto.RegisterType((*K8SObjectMetadata)(nil), "nebulaidl.core.K8sObjectMetadata")
	proto.RegisterMapType((map[string]string)(nil), "nebulaidl.core.K8sObjectMetadata.AnnotationsEntry")
	proto.RegisterMapType((map[string]string)(nil), "nebulaidl.core.K8sObjectMetadata.LabelsEntry")
	proto.RegisterType((*Sql)(nil), "nebulaidl.core.Sql")
}

func init() { proto.RegisterFile("nebulaidl/core/tasks.proto", fileDescriptor_bd8423ba58d6ed80) }
...
var fileDescriptor_bd8423ba58d6ed80 = []byte{
	...
	,
}
