...
func init() {
	...
	proto.RegisterMapType((map[string]*LiteralType)(nil), "nebulaidl.core.TypeStructure.DataclassTypeEntry")
...
func init() { proto.RegisterFile("nebulaidl/core/types.proto", fileDescriptor_51e8add38f4caaed) }
