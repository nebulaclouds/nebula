...
type CreateDownloadLinkRequest struct {
	...
	ArtifactType ArtifactType `protobuf:"varint,1,opt,name=artifact_type,json=artifactType,proto3,enum=nebulaidl.service.ArtifactType" json:"artifact_type,omitempty"`
	// ExpiresIn defines a requested expiration duration for the generated url. The request will be rejected if this
	// exceeds the platform allowed max.
	// +optional. The default value comes from a global config.
	ExpiresIn *duration.Duration `protobuf:"bytes,2,opt,name=expires_in,json=expiresIn,proto3" json:"expires_in,omitempty"`
...
type GetDataRequest struct {
	...
	NebulaUrl             string   `protobuf:"bytes,1,opt,name=nebula_url,json=nebulaUrl,proto3" json:"nebula_url,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetDataRequest) GetNebulaUrl() string {
	if m != nil {
		return m.NebulaUrl
	}
	return ""
...
func init() {
	proto.RegisterEnum("nebulaidl.service.ArtifactType", ArtifactType_name, ArtifactType_value)
	proto.RegisterType((*CreateUploadLocationResponse)(nil), "nebulaidl.service.CreateUploadLocationResponse")
	proto.RegisterType((*CreateUploadLocationRequest)(nil), "nebulaidl.service.CreateUploadLocationRequest")
	proto.RegisterType((*CreateDownloadLocationRequest)(nil), "nebulaidl.service.CreateDownloadLocationRequest")
	proto.RegisterType((*CreateDownloadLocationResponse)(nil), "nebulaidl.service.CreateDownloadLocationResponse")
	proto.RegisterType((*CreateDownloadLinkRequest)(nil), "nebulaidl.service.CreateDownloadLinkRequest")
	proto.RegisterType((*CreateDownloadLinkResponse)(nil), "nebulaidl.service.CreateDownloadLinkResponse")
	proto.RegisterType((*PreSignedURLs)(nil), "nebulaidl.service.PreSignedURLs")
	proto.RegisterType((*GetDataRequest)(nil), "nebulaidl.service.GetDataRequest")
	proto.RegisterType((*GetDataResponse)(nil), "nebulaidl.service.GetDataResponse")
}

func init() { proto.RegisterFile("nebulaidl/service/dataproxy.proto", fileDescriptor_bffb71366d75dab0) }
...
func (c *dataProxyServiceClient) CreateUploadLocation(ctx context.Context, in *CreateUploadLocationRequest, opts ...grpc.CallOption) (*CreateUploadLocationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nebulaidl.service.DataProxyService/CreateUploadLocation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataProxyServiceClient) CreateDownloadLocation(ctx context.Context, in *CreateDownloadLocationRequest, opts ...grpc.CallOption) (*CreateDownloadLocationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nebulaidl.service.DataProxyService/CreateDownloadLocation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataProxyServiceClient) CreateDownloadLink(ctx context.Context, in *CreateDownloadLinkRequest, opts ...grpc.CallOption) (*CreateDownloadLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nebulaidl.service.DataProxyService/CreateDownloadLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataProxyServiceClient) GetData(ctx context.Context, in *GetDataRequest, opts ...grpc.CallOption) (*GetDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nebulaidl.service.DataProxyService/GetData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DataProxyService_CreateUploadLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nebulaidl.service.DataProxyService/CreateUploadLocation",
	}
...
func _DataProxyService_CreateDownloadLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nebulaidl.service.DataProxyService/CreateDownloadLocation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DataProxyService_CreateDownloadLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nebulaidl.service.DataProxyService/CreateDownloadLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DataProxyService_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nebulaidl.service.DataProxyService/GetData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _DataProxyService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "nebulaidl.service.DataProxyService",
	...
	Metadata: "nebulaidl/service/dataproxy.proto",
}
