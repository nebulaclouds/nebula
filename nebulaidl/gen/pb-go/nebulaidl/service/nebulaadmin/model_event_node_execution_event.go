...
type EventNodeExecutionEvent struct {
	...
	WorkflowNodeMetadata *NebulaidleventWorkflowNodeMetadata `json:"workflow_node_metadata,omitempty"`
	TaskNodeMetadata *NebulaidleventTaskNodeMetadata `json:"task_node_metadata,omitempty"`
