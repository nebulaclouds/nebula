...
func init() {
	proto.RegisterType((*DistributedTensorflowTrainingTask)(nil), "nebulaidl.plugins.kubeflow.DistributedTensorflowTrainingTask")
	proto.RegisterType((*DistributedTensorflowTrainingReplicaSpec)(nil), "nebulaidl.plugins.kubeflow.DistributedTensorflowTrainingReplicaSpec")
}

func init() {
	proto.RegisterFile("nebulaidl/plugins/kubeflow/tensorflow.proto", fileDescriptor_93de2bd764ddf01a)
}
