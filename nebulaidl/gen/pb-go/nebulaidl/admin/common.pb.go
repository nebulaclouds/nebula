...
type NamedEntityMetadata struct {
	...
	State                NamedEntityState `protobuf:"varint,2,opt,name=state,proto3,enum=nebulaidl.admin.NamedEntityState" json:"state,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
type Sort struct {
	...
	// +optional
	Direction            Sort_Direction `protobuf:"varint,2,opt,name=direction,proto3,enum=nebulaidl.admin.Sort_Direction" json:"direction,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
type Notification struct {
	...
	// +required
	Phases []core.WorkflowExecution_Phase `protobuf:"varint,1,rep,packed,name=phases,proto3,enum=nebulaidl.core.WorkflowExecution_Phase" json:"phases,omitempty"`
...
func (m *NebulaURLs) Reset()         { *m = NebulaURLs{} }
func (m *NebulaURLs) String() string { return proto.CompactTextString(m) }
func (*NebulaURLs) ProtoMessage()    {}
func (*NebulaURLs) Descriptor() ([]byte, []int) {
	return fileDescriptor_7c2cf612a185829c, []int{23}
}

func (m *NebulaURLs) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NebulaURLs.Unmarshal(m, b)
}
func (m *NebulaURLs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_NebulaURLs.Marshal(b, m, deterministic)
}
func (m *NebulaURLs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NebulaURLs.Merge(m, src)
}
func (m *NebulaURLs) XXX_Size() int {
	return xxx_messageInfo_NebulaURLs.Size(m)
}
func (m *NebulaURLs) XXX_DiscardUnknown() {
	xxx_messageInfo_NebulaURLs.DiscardUnknown(m)
}

var xxx_messageInfo_NebulaURLs proto.InternalMessageInfo

func (m *NebulaURLs) GetInputs() string {
	if m != nil {
		return m.Inputs
	}
	return ""
...
func (m *NebulaURLs) GetOutputs() string {
	if m != nil {
		return m.Outputs
	}
	return ""
...
func (m *NebulaURLs) GetDeck() string {
	if m != nil {
		return m.Deck
	}
	return ""
...
func init() {
	proto.RegisterEnum("nebulaidl.admin.NamedEntityState", NamedEntityState_name, NamedEntityState_value)
	proto.RegisterEnum("nebulaidl.admin.Sort_Direction", Sort_Direction_name, Sort_Direction_value)
	proto.RegisterType((*NamedEntityIdentifier)(nil), "nebulaidl.admin.NamedEntityIdentifier")
	proto.RegisterType((*NamedEntityMetadata)(nil), "nebulaidl.admin.NamedEntityMetadata")
	proto.RegisterType((*NamedEntity)(nil), "nebulaidl.admin.NamedEntity")
	proto.RegisterType((*Sort)(nil), "nebulaidl.admin.Sort")
	proto.RegisterType((*NamedEntityIdentifierListRequest)(nil), "nebulaidl.admin.NamedEntityIdentifierListRequest")
	proto.RegisterType((*NamedEntityListRequest)(nil), "nebulaidl.admin.NamedEntityListRequest")
	proto.RegisterType((*NamedEntityIdentifierList)(nil), "nebulaidl.admin.NamedEntityIdentifierList")
	proto.RegisterType((*NamedEntityList)(nil), "nebulaidl.admin.NamedEntityList")
	proto.RegisterType((*NamedEntityGetRequest)(nil), "nebulaidl.admin.NamedEntityGetRequest")
	proto.RegisterType((*NamedEntityUpdateRequest)(nil), "nebulaidl.admin.NamedEntityUpdateRequest")
	proto.RegisterType((*NamedEntityUpdateResponse)(nil), "nebulaidl.admin.NamedEntityUpdateResponse")
	proto.RegisterType((*ObjectGetRequest)(nil), "nebulaidl.admin.ObjectGetRequest")
	proto.RegisterType((*ResourceListRequest)(nil), "nebulaidl.admin.ResourceListRequest")
	proto.RegisterType((*EmailNotification)(nil), "nebulaidl.admin.EmailNotification")
	proto.RegisterType((*PagerDutyNotification)(nil), "nebulaidl.admin.PagerDutyNotification")
	proto.RegisterType((*SlackNotification)(nil), "nebulaidl.admin.SlackNotification")
	proto.RegisterType((*Notification)(nil), "nebulaidl.admin.Notification")
	proto.RegisterType((*UrlBlob)(nil), "nebulaidl.admin.UrlBlob")
	proto.RegisterType((*Labels)(nil), "nebulaidl.admin.Labels")
	proto.RegisterMapType((map[string]string)(nil), "nebulaidl.admin.Labels.ValuesEntry")
	proto.RegisterType((*Annotations)(nil), "nebulaidl.admin.Annotations")
	proto.RegisterMapType((map[string]string)(nil), "nebulaidl.admin.Annotations.ValuesEntry")
	proto.RegisterType((*Envs)(nil), "nebulaidl.admin.Envs")
	proto.RegisterType((*AuthRole)(nil), "nebulaidl.admin.AuthRole")
	proto.RegisterType((*RawOutputDataConfig)(nil), "nebulaidl.admin.RawOutputDataConfig")
	proto.RegisterType((*NebulaURLs)(nil), "nebulaidl.admin.NebulaURLs")
}

func init() { proto.RegisterFile("nebulaidl/admin/common.proto", fileDescriptor_7c2cf612a185829c) }
