...
type NodeExecutionGetDataResponse struct {
	...
	NebulaUrls            *NebulaURLs                   `protobuf:"bytes,17,opt,name=nebula_urls,json=nebulaUrls,proto3" json:"nebula_urls,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (m *NodeExecutionGetDataResponse) GetNebulaUrls() *NebulaURLs {
	if m != nil {
		return m.NebulaUrls
	}
	return nil
...
func init() {
	proto.RegisterType((*NodeExecutionGetRequest)(nil), "nebulaidl.admin.NodeExecutionGetRequest")
	proto.RegisterType((*NodeExecutionListRequest)(nil), "nebulaidl.admin.NodeExecutionListRequest")
	proto.RegisterType((*NodeExecutionForTaskListRequest)(nil), "nebulaidl.admin.NodeExecutionForTaskListRequest")
	proto.RegisterType((*NodeExecution)(nil), "nebulaidl.admin.NodeExecution")
	proto.RegisterType((*NodeExecutionMetaData)(nil), "nebulaidl.admin.NodeExecutionMetaData")
	proto.RegisterType((*NodeExecutionList)(nil), "nebulaidl.admin.NodeExecutionList")
	proto.RegisterType((*NodeExecutionClosure)(nil), "nebulaidl.admin.NodeExecutionClosure")
	proto.RegisterType((*WorkflowNodeMetadata)(nil), "nebulaidl.admin.WorkflowNodeMetadata")
	proto.RegisterType((*TaskNodeMetadata)(nil), "nebulaidl.admin.TaskNodeMetadata")
	proto.RegisterType((*DynamicWorkflowNodeMetadata)(nil), "nebulaidl.admin.DynamicWorkflowNodeMetadata")
	proto.RegisterType((*NodeExecutionGetDataRequest)(nil), "nebulaidl.admin.NodeExecutionGetDataRequest")
	proto.RegisterType((*NodeExecutionGetDataResponse)(nil), "nebulaidl.admin.NodeExecutionGetDataResponse")
}

func init() {
	proto.RegisterFile("nebulaidl/admin/node_execution.proto", fileDescriptor_f73b3eae493fd736)
}
