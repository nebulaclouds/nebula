...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fplugins_2ftensorflow_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fplugins_2ftensorflow_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fplugins_2ftensorflow_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fplugins_2ftensorflow_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::plugins::DistributedTensorflowTrainingTask* Arena::CreateMaybeMessage<::nebulaidl::plugins::DistributedTensorflowTrainingTask>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace plugins {
...
class DistributedTensorflowTrainingTask final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.DistributedTensorflowTrainingTask) */ {
 public:
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fplugins_2ftensorflow_2eproto;
};
// ===================================================================
...
inline ::google::protobuf::int32 DistributedTensorflowTrainingTask::workers() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.DistributedTensorflowTrainingTask.workers)
  return workers_;
}
inline void DistributedTensorflowTrainingTask::set_workers(::google::protobuf::int32 value) {
  
  workers_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.DistributedTensorflowTrainingTask.workers)
}
...
inline ::google::protobuf::int32 DistributedTensorflowTrainingTask::ps_replicas() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.DistributedTensorflowTrainingTask.ps_replicas)
  return ps_replicas_;
}
inline void DistributedTensorflowTrainingTask::set_ps_replicas(::google::protobuf::int32 value) {
  
  ps_replicas_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.DistributedTensorflowTrainingTask.ps_replicas)
}
...
inline ::google::protobuf::int32 DistributedTensorflowTrainingTask::chief_replicas() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.DistributedTensorflowTrainingTask.chief_replicas)
...
inline void DistributedTensorflowTrainingTask::set_chief_replicas(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.DistributedTensorflowTrainingTask.chief_replicas)
}
...
inline ::google::protobuf::int32 DistributedTensorflowTrainingTask::evaluator_replicas() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.DistributedTensorflowTrainingTask.evaluator_replicas)
...
inline void DistributedTensorflowTrainingTask::set_evaluator_replicas(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.DistributedTensorflowTrainingTask.evaluator_replicas)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fplugins_2ftensorflow_2eproto
