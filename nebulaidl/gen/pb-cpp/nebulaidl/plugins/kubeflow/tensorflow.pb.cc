...
const ::google::protobuf::uint32 TableStruct_nebulaidl_2fplugins_2fkubeflow_2ftensorflow_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::nebulaidl::plugins::kubeflow::DistributedTensorflowTrainingTask, evaluator_replicas_),
  ~0u,  // no _has_bits_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 10, -1, sizeof(::nebulaidl::plugins::kubeflow::DistributedTensorflowTrainingReplicaSpec)},
};
...
::google::protobuf::internal::DescriptorTable descriptor_table_nebulaidl_2fplugins_2fkubeflow_2ftensorflow_2eproto = {
  ...
  "nebulaidl/plugins/kubeflow/tensorflow.proto", &assign_descriptors_table_nebulaidl_2fplugins_2fkubeflow_2ftensorflow_2eproto, 870,
};
...
void DistributedTensorflowTrainingTask::InitAsDefaultInstance() {
  ...
  ::nebulaidl::plugins::kubeflow::_DistributedTensorflowTrainingTask_default_instance_._instance.get_mutable()->evaluator_replicas_ = const_cast< ::nebulaidl::plugins::kubeflow::DistributedTensorflowTrainingReplicaSpec*>(
      ::nebulaidl::plugins::kubeflow::DistributedTensorflowTrainingReplicaSpec::internal_default_instance());
}
class DistributedTensorflowTrainingTask::HasBitSetters {
 public:
  ...
  static const ::nebulaidl::plugins::kubeflow::DistributedTensorflowTrainingReplicaSpec& evaluator_replicas(const DistributedTensorflowTrainingTask* msg);
};
...
const ::nebulaidl::plugins::kubeflow::DistributedTensorflowTrainingReplicaSpec&
DistributedTensorflowTrainingTask::HasBitSetters::evaluator_replicas(const DistributedTensorflowTrainingTask* msg) {
  return *msg->evaluator_replicas_;
}
...
DistributedTensorflowTrainingTask::DistributedTensorflowTrainingTask(const DistributedTensorflowTrainingTask& from)
  ...
  if (from.has_evaluator_replicas()) {
    evaluator_replicas_ = new ::nebulaidl::plugins::kubeflow::DistributedTensorflowTrainingReplicaSpec(*from.evaluator_replicas_);
  } else {
...
void DistributedTensorflowTrainingTask::SharedCtor() {
  ...
  ::memset(&worker_replicas_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&worker_replicas_)) + sizeof(evaluator_replicas_));
}
...
void DistributedTensorflowTrainingTask::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete evaluator_replicas_;
}
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 5: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::nebulaidl::plugins::kubeflow::DistributedTensorflowTrainingReplicaSpec::_InternalParse;
        object = msg->mutable_evaluator_replicas();
        if (size > end - ptr) goto len_delim_till_end;
        ptr += size;
        GOOGLE_PROTOBUF_PARSER_ASSERT(ctx->ParseExactRange(
            {parser_till_end, object}, ptr - size, ptr));
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (42 & 0xFF)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(
               input, mutable_evaluator_replicas()));
        } else {
          goto handle_unusual;
        }
        break;
...
void DistributedTensorflowTrainingTask::SerializeWithCachedSizes(
  ...
  // .nebulaidl.plugins.kubeflow.DistributedTensorflowTrainingReplicaSpec evaluator_replicas = 5;
  if (this->has_evaluator_replicas()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, HasBitSetters::evaluator_replicas(this), output);
  }
...
::google::protobuf::uint8* DistributedTensorflowTrainingTask::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_evaluator_replicas()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        5, HasBitSetters::evaluator_replicas(this), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:nebulaidl.plugins.kubeflow.DistributedTensorflowTrainingTask)
  ...
  if (from.has_evaluator_replicas()) {
    mutable_evaluator_replicas()->::nebulaidl::plugins::kubeflow::DistributedTensorflowTrainingReplicaSpec::MergeFrom(from.evaluator_replicas());
  }
}
