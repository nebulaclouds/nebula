...
class SpanDefaultTypeInternal {
 public:
  ...
  const ::nebulaidl::core::WorkflowExecutionIdentifier* workflow_id_;
  const ::nebulaidl::core::NodeExecutionIdentifier* node_id_;
  const ::nebulaidl::core::TaskExecutionIdentifier* task_id_;
  ::google::protobuf::internal::ArenaStringPtr operation_id_;
} _Span_default_instance_;
}  // namespace core
}  // namespace nebulaidl
static void InitDefaultsSpan_nebulaidl_2fcore_2fmetrics_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::nebulaidl::core::_Span_default_instance_;
    new (ptr) ::nebulaidl::core::Span();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::nebulaidl::core::Span::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<4> scc_info_Span_nebulaidl_2fcore_2fmetrics_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 4, InitDefaultsSpan_nebulaidl_2fcore_2fmetrics_2eproto}, {
...
void InitDefaults_nebulaidl_2fcore_2fmetrics_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_Span_nebulaidl_2fcore_2fmetrics_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_nebulaidl_2fcore_2fmetrics_2eproto[1];
constexpr ::google::protobuf::EnumDescriptor const** file_level_enum_descriptors_nebulaidl_2fcore_2fmetrics_2eproto = nullptr;
constexpr ::google::protobuf::ServiceDescriptor const** file_level_service_descriptors_nebulaidl_2fcore_2fmetrics_2eproto = nullptr;

const ::google::protobuf::uint32 TableStruct_nebulaidl_2fcore_2fmetrics_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::nebulaidl::core::Span, _internal_metadata_),
  ~0u,  // no _extensions_
  PROTOBUF_FIELD_OFFSET(::nebulaidl::core::Span, _oneof_case_[0]),
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::nebulaidl::core::Span, start_time_),
  PROTOBUF_FIELD_OFFSET(::nebulaidl::core::Span, end_time_),
  offsetof(::nebulaidl::core::SpanDefaultTypeInternal, workflow_id_),
  offsetof(::nebulaidl::core::SpanDefaultTypeInternal, node_id_),
  offsetof(::nebulaidl::core::SpanDefaultTypeInternal, task_id_),
  offsetof(::nebulaidl::core::SpanDefaultTypeInternal, operation_id_),
  PROTOBUF_FIELD_OFFSET(::nebulaidl::core::Span, spans_),
  PROTOBUF_FIELD_OFFSET(::nebulaidl::core::Span, id_),
};
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::nebulaidl::core::Span)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::nebulaidl::core::_Span_default_instance_),
};

::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_nebulaidl_2fcore_2fmetrics_2eproto = {
  {}, AddDescriptors_nebulaidl_2fcore_2fmetrics_2eproto, "nebulaidl/core/metrics.proto", schemas,
  file_default_instances, TableStruct_nebulaidl_2fcore_2fmetrics_2eproto::offsets,
  file_level_metadata_nebulaidl_2fcore_2fmetrics_2eproto, 1, file_level_enum_descriptors_nebulaidl_2fcore_2fmetrics_2eproto, file_level_service_descriptors_nebulaidl_2fcore_2fmetrics_2eproto,
};
...
::google::protobuf::internal::DescriptorTable descriptor_table_nebulaidl_2fcore_2fmetrics_2eproto = {
  ...
  "nebulaidl/core/metrics.proto", &assign_descriptors_table_nebulaidl_2fcore_2fmetrics_2eproto, 533,
};
...
void AddDescriptors_nebulaidl_2fcore_2fmetrics_2eproto() {
 ...
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_nebulaidl_2fcore_2fmetrics_2eproto, deps, 2);
}

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_nebulaidl_2fcore_2fmetrics_2eproto = []() { AddDescriptors_nebulaidl_2fcore_2fmetrics_2eproto(); return true; }();
namespace nebulaidl {
namespace core {
...
void Span::InitAsDefaultInstance() {
  ::nebulaidl::core::_Span_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  ::nebulaidl::core::_Span_default_instance_._instance.get_mutable()->end_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  ::nebulaidl::core::_Span_default_instance_.workflow_id_ = const_cast< ::nebulaidl::core::WorkflowExecutionIdentifier*>(
      ::nebulaidl::core::WorkflowExecutionIdentifier::internal_default_instance());
  ::nebulaidl::core::_Span_default_instance_.node_id_ = const_cast< ::nebulaidl::core::NodeExecutionIdentifier*>(
      ::nebulaidl::core::NodeExecutionIdentifier::internal_default_instance());
  ::nebulaidl::core::_Span_default_instance_.task_id_ = const_cast< ::nebulaidl::core::TaskExecutionIdentifier*>(
      ::nebulaidl::core::TaskExecutionIdentifier::internal_default_instance());
  ::nebulaidl::core::_Span_default_instance_.operation_id_.UnsafeSetDefault(
...
class Span::HasBitSetters {
 public:
  ...
  static const ::nebulaidl::core::WorkflowExecutionIdentifier& workflow_id(const Span* msg);
  static const ::nebulaidl::core::NodeExecutionIdentifier& node_id(const Span* msg);
  static const ::nebulaidl::core::TaskExecutionIdentifier& task_id(const Span* msg);
};
...
void Span::set_allocated_workflow_id(::nebulaidl::core::WorkflowExecutionIdentifier* workflow_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.Span.workflow_id)
}
...
void Span::set_allocated_node_id(::nebulaidl::core::NodeExecutionIdentifier* node_id) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  clear_id();
  if (node_id) {
    ::google::protobuf::Arena* submessage_arena = nullptr;
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.Span.node_id)
}
...
void Span::set_allocated_task_id(::nebulaidl::core::TaskExecutionIdentifier* task_id) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  clear_id();
  if (task_id) {
    ::google::protobuf::Arena* submessage_arena = nullptr;
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.Span.task_id)
}
...
Span::Span()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:nebulaidl.core.Span)
}
Span::Span(const Span& from)
  ...
  switch (from.id_case()) {
    case kWorkflowId: {
      mutable_workflow_id()->::nebulaidl::core::WorkflowExecutionIdentifier::MergeFrom(from.workflow_id());
      break;
    }
    case kNodeId: {
      mutable_node_id()->::nebulaidl::core::NodeExecutionIdentifier::MergeFrom(from.node_id());
      break;
    }
    case kTaskId: {
      mutable_task_id()->::nebulaidl::core::TaskExecutionIdentifier::MergeFrom(from.task_id());
      break;
    }
    case kOperationId: {
  ...
  // @@protoc_insertion_point(copy_constructor:nebulaidl.core.Span)
}
...
Span::~Span() {
  // @@protoc_insertion_point(destructor:nebulaidl.core.Span)
  SharedDtor();
}
...
void Span::clear_id() {
// @@protoc_insertion_point(one_of_clear_start:nebulaidl.core.Span)
  switch (id_case()) {
    case kWorkflowId: {
      delete id_.workflow_id_;
      break;
...
void Span::Clear() {
// @@protoc_insertion_point(message_clear_start:nebulaidl.core.Span)
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 6: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("nebulaidl.core.Span.operation_id");
      ...
      // repeated .nebulaidl.core.Span spans = 7;
      case 7: {
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:nebulaidl.core.Span)
  for (;;) {
      ...
      case 6: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (50 & 0xFF)) {
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            "nebulaidl.core.Span.operation_id"));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:nebulaidl.core.Span)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:nebulaidl.core.Span)
  return false;
#undef DO_
}
...
void Span::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:nebulaidl.core.Span)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:nebulaidl.core.Span)
}

::google::protobuf::uint8* Span::InternalSerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:nebulaidl.core.Span)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:nebulaidl.core.Span)
  return target;
}

size_t Span::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:nebulaidl.core.Span)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:nebulaidl.core.Span)
  GOOGLE_DCHECK_NE(&from, this);
  const Span* source =
      ::google::protobuf::DynamicCastToGenerated<Span>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:nebulaidl.core.Span)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:nebulaidl.core.Span)
    MergeFrom(*source);
  }
}

void Span::MergeFrom(const Span& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:nebulaidl.core.Span)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:nebulaidl.core.Span)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:nebulaidl.core.Span)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata Span::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_nebulaidl_2fcore_2fmetrics_2eproto);
  return ::file_level_metadata_nebulaidl_2fcore_2fmetrics_2eproto[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> PROTOBUF_NOINLINE ::nebulaidl::core::Span* Arena::CreateMaybeMessage< ::nebulaidl::core::Span >(Arena* arena) {
  return Arena::CreateInternal< ::nebulaidl::core::Span >(arena);
}
}  // namespace protobuf
}  // namespace google
