...
template<> ::nebulaidl::core::TypeStructure_DataclassTypeEntry_DoNotUse* Arena::CreateMaybeMessage<::nebulaidl::core::TypeStructure_DataclassTypeEntry_DoNotUse>(Arena*);
...
class TypeStructure final :
 ...
 public:
  ...
  const ::google::protobuf::Map< ::std::string, ::nebulaidl::core::LiteralType >&
      dataclass_type() const;
  ::google::protobuf::Map< ::std::string, ::nebulaidl::core::LiteralType >*
...
inline const ::google::protobuf::Map< ::std::string, ::nebulaidl::core::LiteralType >&
TypeStructure::dataclass_type() const {
  // @@protoc_insertion_point(field_map:nebulaidl.core.TypeStructure.dataclass_type)
  return dataclass_type_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::nebulaidl::core::LiteralType >*
TypeStructure::mutable_dataclass_type() {
  // @@protoc_insertion_point(field_mutable_map:nebulaidl.core.TypeStructure.dataclass_type)
