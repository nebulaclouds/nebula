...
class NodeExecutionMetaData final :
 ...
 public:
  ...
  // bool is_array = 5;
  void clear_is_array();
  static const int kIsArrayFieldNumber = 5;
  bool is_array() const;
...
// bool is_array = 5;
inline void NodeExecutionMetaData::clear_is_array() {
  is_array_ = false;
}
inline bool NodeExecutionMetaData::is_array() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.NodeExecutionMetaData.is_array)
  return is_array_;
}
inline void NodeExecutionMetaData::set_is_array(bool value) {
  
  is_array_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.NodeExecutionMetaData.is_array)
}
