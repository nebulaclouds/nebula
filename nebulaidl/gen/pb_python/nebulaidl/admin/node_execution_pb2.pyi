...
from nebulaidl.core import execution_pb2 as _execution_pb2
from nebulaidl.core import catalog_pb2 as _catalog_pb2
from nebulaidl.core import compiler_pb2 as _compiler_pb2
from nebulaidl.core import identifier_pb2 as _identifier_pb2
from nebulaidl.core import literals_pb2 as _literals_pb2
...
class NodeExecutionGetDataResponse(_message.Message):
    __slots__ = ["inputs", "outputs", "full_inputs", "full_outputs", "dynamic_workflow", "nebula_urls"]
    ...
    NEBULA_URLS_FIELD_NUMBER: _ClassVar[int]
    ...
    nebula_urls: _common_pb2.NebulaURLs
    def __init__(self, inputs: _Optional[_Union[_common_pb2.UrlBlob, _Mapping]] = ..., outputs: _Optional[_Union[_common_pb2.UrlBlob, _Mapping]] = ..., full_inputs: _Optional[_Union[_literals_pb2.LiteralMap, _Mapping]] = ..., full_outputs: _Optional[_Union[_literals_pb2.LiteralMap, _Mapping]] = ..., dynamic_workflow: _Optional[_Union[DynamicWorkflowNodeMetadata, _Mapping]] = ..., nebula_urls: _Optional[_Union[_common_pb2.NebulaURLs, _Mapping]] = ...) -> None: ...
