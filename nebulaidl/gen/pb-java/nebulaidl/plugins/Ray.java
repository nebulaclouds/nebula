...
public final class Ray {
  ...
  public interface RayJobOrBuilder extends
      // @@protoc_insertion_point(interface_extends:nebulaidl.plugins.RayJob)
     ...
     * <code>.nebulaidl.plugins.RayCluster ray_cluster = 1;</code>
     */
    nebulaidl.plugins.Ray.RayCluster getRayCluster();
    /**
     * <pre>
     * RayClusterSpec is the cluster template to run the job
     * </pre>
     ...
     * <code>.nebulaidl.plugins.RayCluster ray_cluster = 1;</code>
     */
    nebulaidl.plugins.Ray.RayClusterOrBuilder getRayClusterOrBuilder();
   ...
   * </pre>
   *
   * Protobuf type {@code nebulaidl.plugins.RayJob}
   */
  public  static final class RayJob extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:nebulaidl.plugins.RayJob)
      RayJobOrBuilder {
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              nebulaidl.plugins.Ray.RayCluster.Builder subBuilder = null;
              if (rayCluster_ != null) {
                subBuilder = rayCluster_.toBuilder();
              }
              rayCluster_ = input.readMessage(nebulaidl.plugins.Ray.RayCluster.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_RayJob_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_RayJob_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              nebulaidl.plugins.Ray.RayJob.class, nebulaidl.plugins.Ray.RayJob.Builder.class);
    }

    public static final int RAY_CLUSTER_FIELD_NUMBER = 1;
    private nebulaidl.plugins.Ray.RayCluster rayCluster_;
    /**
     * <pre>
     * RayClusterSpec is the cluster template to run the job
     * </pre>
     ...
     * <code>.nebulaidl.plugins.RayCluster ray_cluster = 1;</code>
     */
    public nebulaidl.plugins.Ray.RayCluster getRayCluster() {
      return rayCluster_ == null ? nebulaidl.plugins.Ray.RayCluster.getDefaultInstance() : rayCluster_;
    }
    /**
     * <pre>
     * RayClusterSpec is the cluster template to run the job
     ...
     * <code>.nebulaidl.plugins.RayCluster ray_cluster = 1;</code>
     */
    public nebulaidl.plugins.Ray.RayClusterOrBuilder getRayClusterOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof nebulaidl.plugins.Ray.RayJob)) {
        return super.equals(obj);
      }
      nebulaidl.plugins.Ray.RayJob other = (nebulaidl.plugins.Ray.RayJob) obj;
    ...
    public static nebulaidl.plugins.Ray.RayJob parseFrom(
    ...
    public static nebulaidl.plugins.Ray.RayJob parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static nebulaidl.plugins.Ray.RayJob parseFrom(
    ...
    public static nebulaidl.plugins.Ray.RayJob parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static nebulaidl.plugins.Ray.RayJob parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static nebulaidl.plugins.Ray.RayJob parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(nebulaidl.plugins.Ray.RayJob prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:nebulaidl.plugins.RayJob)
        nebulaidl.plugins.Ray.RayJobOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_RayJob_descriptor;
      }
      ...
      // Construct using nebulaidl.plugins.Ray.RayJob.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public nebulaidl.plugins.Ray.RayJob getDefaultInstanceForType() {
        return nebulaidl.plugins.Ray.RayJob.getDefaultInstance();
      }

      @java.lang.Override
      public nebulaidl.plugins.Ray.RayJob build() {
        nebulaidl.plugins.Ray.RayJob result = buildPartial();
      ...
      @java.lang.Override
      public nebulaidl.plugins.Ray.RayJob buildPartial() {
        nebulaidl.plugins.Ray.RayJob result = new nebulaidl.plugins.Ray.RayJob(this);
        if (rayClusterBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof nebulaidl.plugins.Ray.RayJob) {
          return mergeFrom((nebulaidl.plugins.Ray.RayJob)other);
        } else {
      ...
      public Builder mergeFrom(nebulaidl.plugins.Ray.RayJob other) {
        if (other == nebulaidl.plugins.Ray.RayJob.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        nebulaidl.plugins.Ray.RayJob parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (nebulaidl.plugins.Ray.RayJob) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          nebulaidl.plugins.Ray.RayCluster, nebulaidl.plugins.Ray.RayCluster.Builder, nebulaidl.plugins.Ray.RayClusterOrBuilder> rayClusterBuilder_;
      /**
       * <pre>
       * RayClusterSpec is the cluster template to run the job
       * </pre>
       ...
       * <code>.nebulaidl.plugins.RayCluster ray_cluster = 1;</code>
       */
      public Builder setRayCluster(nebulaidl.plugins.Ray.RayCluster value) {
        if (rayClusterBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setRayCluster(
          nebulaidl.plugins.Ray.RayCluster.Builder builderForValue) {
        if (rayClusterBuilder_ == null) {
       ...
       * <code>.nebulaidl.plugins.RayCluster ray_cluster = 1;</code>
       */
      public Builder mergeRayCluster(nebulaidl.plugins.Ray.RayCluster value) {
        if (rayClusterBuilder_ == null) {
          if (rayCluster_ != null) {
            rayCluster_ =
              nebulaidl.plugins.Ray.RayCluster.newBuilder(rayCluster_).mergeFrom(value).buildPartial();
          } else {
            rayCluster_ = value;
          }
          onChanged();
       ...
       * <code>.nebulaidl.plugins.RayCluster ray_cluster = 1;</code>
       */
      public nebulaidl.plugins.Ray.RayCluster.Builder getRayClusterBuilder() {
      ...
      public nebulaidl.plugins.Ray.RayClusterOrBuilder getRayClusterOrBuilder() {
        if (rayClusterBuilder_ != null) {
          ...
          return rayCluster_ == null ?
              nebulaidl.plugins.Ray.RayCluster.getDefaultInstance() : rayCluster_;
        }
      }
      /**
       * <pre>
  ...
  checkByteStringIsUtf8(value);
      ...
      // @@protoc_insertion_point(builder_scope:nebulaidl.plugins.RayJob)
    }

    // @@protoc_insertion_point(class_scope:nebulaidl.plugins.RayJob)
    private static final nebulaidl.plugins.Ray.RayJob DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new nebulaidl.plugins.Ray.RayJob();
    }

    public static nebulaidl.plugins.Ray.RayJob getDefaultInstance() {
  ...
  public interface RayClusterOrBuilder extends
      // @@protoc_insertion_point(interface_extends:nebulaidl.plugins.RayCluster)
      com.google.protobuf.MessageOrBuilder {
     ...
     * <code>.nebulaidl.plugins.HeadGroupSpec head_group_spec = 1;</code>
     */
    nebulaidl.plugins.Ray.HeadGroupSpec getHeadGroupSpec();
    /**
     * <pre>
     * HeadGroupSpecs are the spec for the head pod
     * </pre>
     ...
     * <code>.nebulaidl.plugins.HeadGroupSpec head_group_spec = 1;</code>
     */
    nebulaidl.plugins.Ray.HeadGroupSpecOrBuilder getHeadGroupSpecOrBuilder();
     ...
     * <code>repeated .nebulaidl.plugins.WorkerGroupSpec worker_group_spec = 2;</code>
     */
    nebulaidl.plugins.Ray.WorkerGroupSpec getWorkerGroupSpec(int index);
    /**
     * <pre>
     * WorkerGroupSpecs are the specs for the worker pods
     * </pre>
     ...
     * <code>repeated .nebulaidl.plugins.WorkerGroupSpec worker_group_spec = 2;</code>
     */
    nebulaidl.plugins.Ray.WorkerGroupSpecOrBuilder getWorkerGroupSpecOrBuilder(
        int index);
  }
  /**
   * <pre>
   ...
   * </pre>
   *
   * Protobuf type {@code nebulaidl.plugins.RayCluster}
   */
  public  static final class RayCluster extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:nebulaidl.plugins.RayCluster)
      RayClusterOrBuilder {
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              nebulaidl.plugins.Ray.HeadGroupSpec.Builder subBuilder = null;
              if (headGroupSpec_ != null) {
                subBuilder = headGroupSpec_.toBuilder();
              }
              headGroupSpec_ = input.readMessage(nebulaidl.plugins.Ray.HeadGroupSpec.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 18: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                workerGroupSpec_ = new java.util.ArrayList<nebulaidl.plugins.Ray.WorkerGroupSpec>();
                mutable_bitField0_ |= 0x00000002;
              }
              workerGroupSpec_.add(
                  input.readMessage(nebulaidl.plugins.Ray.WorkerGroupSpec.parser(), extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_RayCluster_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_RayCluster_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              nebulaidl.plugins.Ray.RayCluster.class, nebulaidl.plugins.Ray.RayCluster.Builder.class);
    }

    private int bitField0_;
    public static final int HEAD_GROUP_SPEC_FIELD_NUMBER = 1;
    private nebulaidl.plugins.Ray.HeadGroupSpec headGroupSpec_;
    /**
     * <pre>
     * HeadGroupSpecs are the spec for the head pod
     * </pre>
     ...
     * <code>.nebulaidl.plugins.HeadGroupSpec head_group_spec = 1;</code>
     */
    public nebulaidl.plugins.Ray.HeadGroupSpec getHeadGroupSpec() {
      return headGroupSpec_ == null ? nebulaidl.plugins.Ray.HeadGroupSpec.getDefaultInstance() : headGroupSpec_;
    }
    /**
     * <pre>
     * HeadGroupSpecs are the spec for the head pod
     ...
     * <code>.nebulaidl.plugins.HeadGroupSpec head_group_spec = 1;</code>
     */
    public nebulaidl.plugins.Ray.HeadGroupSpecOrBuilder getHeadGroupSpecOrBuilder() {
      return getHeadGroupSpec();
    }

    public static final int WORKER_GROUP_SPEC_FIELD_NUMBER = 2;
    private java.util.List<nebulaidl.plugins.Ray.WorkerGroupSpec> workerGroupSpec_;
    /**
     * <pre>
     * WorkerGroupSpecs are the specs for the worker pods
     * </pre>
     ...
     * <code>repeated .nebulaidl.plugins.WorkerGroupSpec worker_group_spec = 2;</code>
     */
    public java.util.List<nebulaidl.plugins.Ray.WorkerGroupSpec> getWorkerGroupSpecList() {
     ...
     * <code>repeated .nebulaidl.plugins.WorkerGroupSpec worker_group_spec = 2;</code>
     */
    public nebulaidl.plugins.Ray.WorkerGroupSpec getWorkerGroupSpec(int index) {
     ...
     * <code>repeated .nebulaidl.plugins.WorkerGroupSpec worker_group_spec = 2;</code>
     */
    public nebulaidl.plugins.Ray.WorkerGroupSpecOrBuilder getWorkerGroupSpecOrBuilder(
        int index) {
      return workerGroupSpec_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof nebulaidl.plugins.Ray.RayCluster)) {
        return super.equals(obj);
      }
      nebulaidl.plugins.Ray.RayCluster other = (nebulaidl.plugins.Ray.RayCluster) obj;
    ...
    public static nebulaidl.plugins.Ray.RayCluster parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static nebulaidl.plugins.Ray.RayCluster parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static nebulaidl.plugins.Ray.RayCluster parseFrom(
    ...
    public static nebulaidl.plugins.Ray.RayCluster parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static nebulaidl.plugins.Ray.RayCluster parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static nebulaidl.plugins.Ray.RayCluster parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(nebulaidl.plugins.Ray.RayCluster prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:nebulaidl.plugins.RayCluster)
        nebulaidl.plugins.Ray.RayClusterOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_RayCluster_descriptor;
      }
      ...
      // Construct using nebulaidl.plugins.Ray.RayCluster.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public nebulaidl.plugins.Ray.RayCluster getDefaultInstanceForType() {
        return nebulaidl.plugins.Ray.RayCluster.getDefaultInstance();
      }

      @java.lang.Override
      public nebulaidl.plugins.Ray.RayCluster build() {
        nebulaidl.plugins.Ray.RayCluster result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public nebulaidl.plugins.Ray.RayCluster buildPartial() {
        nebulaidl.plugins.Ray.RayCluster result = new nebulaidl.plugins.Ray.RayCluster(this);
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof nebulaidl.plugins.Ray.RayCluster) {
          return mergeFrom((nebulaidl.plugins.Ray.RayCluster)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(nebulaidl.plugins.Ray.RayCluster other) {
        if (other == nebulaidl.plugins.Ray.RayCluster.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        nebulaidl.plugins.Ray.RayCluster parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (nebulaidl.plugins.Ray.RayCluster) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private nebulaidl.plugins.Ray.HeadGroupSpec headGroupSpec_;
      private com.google.protobuf.SingleFieldBuilderV3<
          nebulaidl.plugins.Ray.HeadGroupSpec, nebulaidl.plugins.Ray.HeadGroupSpec.Builder, nebulaidl.plugins.Ray.HeadGroupSpecOrBuilder> headGroupSpecBuilder_;
      /**
       * <pre>
       * HeadGroupSpecs are the spec for the head pod
       * </pre>
       ...
       * <code>.nebulaidl.plugins.HeadGroupSpec head_group_spec = 1;</code>
       */
      public Builder setHeadGroupSpec(nebulaidl.plugins.Ray.HeadGroupSpec value) {
        if (headGroupSpecBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setHeadGroupSpec(
          nebulaidl.plugins.Ray.HeadGroupSpec.Builder builderForValue) {
        if (headGroupSpecBuilder_ == null) {
       ...
       * <code>.nebulaidl.plugins.HeadGroupSpec head_group_spec = 1;</code>
       */
      public Builder mergeHeadGroupSpec(nebulaidl.plugins.Ray.HeadGroupSpec value) {
        if (headGroupSpecBuilder_ == null) {
          if (headGroupSpec_ != null) {
            headGroupSpec_ =
              nebulaidl.plugins.Ray.HeadGroupSpec.newBuilder(headGroupSpec_).mergeFrom(value).buildPartial();
          } else {
            headGroupSpec_ = value;
          }
          onChanged();
       ...
       * <code>.nebulaidl.plugins.HeadGroupSpec head_group_spec = 1;</code>
       */
      public nebulaidl.plugins.Ray.HeadGroupSpec.Builder getHeadGroupSpecBuilder() {
      ...
      public nebulaidl.plugins.Ray.HeadGroupSpecOrBuilder getHeadGroupSpecOrBuilder() {
        if (headGroupSpecBuilder_ != null) {
          ...
          return headGroupSpec_ == null ?
              nebulaidl.plugins.Ray.HeadGroupSpec.getDefaultInstance() : headGroupSpec_;
        }
      }
      /**
       * <pre>
      ...
      private void ensureWorkerGroupSpecIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          workerGroupSpec_ = new java.util.ArrayList<nebulaidl.plugins.Ray.WorkerGroupSpec>(workerGroupSpec_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          nebulaidl.plugins.Ray.WorkerGroupSpec, nebulaidl.plugins.Ray.WorkerGroupSpec.Builder, nebulaidl.plugins.Ray.WorkerGroupSpecOrBuilder> workerGroupSpecBuilder_;
      ...
      public Builder setWorkerGroupSpec(
          int index, nebulaidl.plugins.Ray.WorkerGroupSpec value) {
        if (workerGroupSpecBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setWorkerGroupSpec(
          int index, nebulaidl.plugins.Ray.WorkerGroupSpec.Builder builderForValue) {
        if (workerGroupSpecBuilder_ == null) {
          ensureWorkerGroupSpecIsMutable();
       ...
       * <code>repeated .nebulaidl.plugins.WorkerGroupSpec worker_group_spec = 2;</code>
       */
      public Builder addWorkerGroupSpec(nebulaidl.plugins.Ray.WorkerGroupSpec value) {
        if (workerGroupSpecBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addWorkerGroupSpec(
          nebulaidl.plugins.Ray.WorkerGroupSpec.Builder builderForValue) {
        if (workerGroupSpecBuilder_ == null) {
          ensureWorkerGroupSpecIsMutable();
      ...
      public Builder addAllWorkerGroupSpec(
          java.lang.Iterable<? extends nebulaidl.plugins.Ray.WorkerGroupSpec> values) {
        if (workerGroupSpecBuilder_ == null) {
          ensureWorkerGroupSpecIsMutable();
       ...
       * <code>repeated .nebulaidl.plugins.WorkerGroupSpec worker_group_spec = 2;</code>
       */
      public nebulaidl.plugins.Ray.WorkerGroupSpec.Builder getWorkerGroupSpecBuilder(
          int index) {
       ...
       * <code>repeated .nebulaidl.plugins.WorkerGroupSpec worker_group_spec = 2;</code>
       */
      public nebulaidl.plugins.Ray.WorkerGroupSpec.Builder addWorkerGroupSpecBuilder() {
        return getWorkerGroupSpecFieldBuilder().addBuilder(
            nebulaidl.plugins.Ray.WorkerGroupSpec.getDefaultInstance());
      }
      /**
       * <pre>
       * WorkerGroupSpecs are the specs for the worker pods
      ...
      public nebulaidl.plugins.Ray.WorkerGroupSpec.Builder addWorkerGroupSpecBuilder(
          int index) {
        return getWorkerGroupSpecFieldBuilder().addBuilder(
            index, nebulaidl.plugins.Ray.WorkerGroupSpec.getDefaultInstance());
      }
      /**
       * <pre>
       * WorkerGroupSpecs are the specs for the worker pods
      ...
      // @@protoc_insertion_point(builder_scope:nebulaidl.plugins.RayCluster)
    }

    // @@protoc_insertion_point(class_scope:nebulaidl.plugins.RayCluster)
    private static final nebulaidl.plugins.Ray.RayCluster DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new nebulaidl.plugins.Ray.RayCluster();
    }

    public static nebulaidl.plugins.Ray.RayCluster getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface HeadGroupSpecOrBuilder extends
      // @@protoc_insertion_point(interface_extends:nebulaidl.plugins.HeadGroupSpec)
      com.google.protobuf.MessageOrBuilder {
   ...
   * </pre>
   *
   * Protobuf type {@code nebulaidl.plugins.HeadGroupSpec}
   */
  public  static final class HeadGroupSpec extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:nebulaidl.plugins.HeadGroupSpec)
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_HeadGroupSpec_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_HeadGroupSpec_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              nebulaidl.plugins.Ray.HeadGroupSpec.class, nebulaidl.plugins.Ray.HeadGroupSpec.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof nebulaidl.plugins.Ray.HeadGroupSpec)) {
        return super.equals(obj);
      }
      nebulaidl.plugins.Ray.HeadGroupSpec other = (nebulaidl.plugins.Ray.HeadGroupSpec) obj;
    ...
    public static nebulaidl.plugins.Ray.HeadGroupSpec parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static nebulaidl.plugins.Ray.HeadGroupSpec parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static nebulaidl.plugins.Ray.HeadGroupSpec parseFrom(
    ...
    public static nebulaidl.plugins.Ray.HeadGroupSpec parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static nebulaidl.plugins.Ray.HeadGroupSpec parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static nebulaidl.plugins.Ray.HeadGroupSpec parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(nebulaidl.plugins.Ray.HeadGroupSpec prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:nebulaidl.plugins.HeadGroupSpec)
        nebulaidl.plugins.Ray.HeadGroupSpecOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_HeadGroupSpec_descriptor;
      }
      ...
      // Construct using nebulaidl.plugins.Ray.HeadGroupSpec.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public nebulaidl.plugins.Ray.HeadGroupSpec getDefaultInstanceForType() {
        return nebulaidl.plugins.Ray.HeadGroupSpec.getDefaultInstance();
      }

      @java.lang.Override
      public nebulaidl.plugins.Ray.HeadGroupSpec build() {
        nebulaidl.plugins.Ray.HeadGroupSpec result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public nebulaidl.plugins.Ray.HeadGroupSpec buildPartial() {
        nebulaidl.plugins.Ray.HeadGroupSpec result = new nebulaidl.plugins.Ray.HeadGroupSpec(this);
        int from_bitField0_ = bitField0_;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof nebulaidl.plugins.Ray.HeadGroupSpec) {
          return mergeFrom((nebulaidl.plugins.Ray.HeadGroupSpec)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(nebulaidl.plugins.Ray.HeadGroupSpec other) {
        if (other == nebulaidl.plugins.Ray.HeadGroupSpec.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        nebulaidl.plugins.Ray.HeadGroupSpec parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (nebulaidl.plugins.Ray.HeadGroupSpec) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      // @@protoc_insertion_point(builder_scope:nebulaidl.plugins.HeadGroupSpec)
    }

    // @@protoc_insertion_point(class_scope:nebulaidl.plugins.HeadGroupSpec)
    private static final nebulaidl.plugins.Ray.HeadGroupSpec DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new nebulaidl.plugins.Ray.HeadGroupSpec();
    }

    public static nebulaidl.plugins.Ray.HeadGroupSpec getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface WorkerGroupSpecOrBuilder extends
      // @@protoc_insertion_point(interface_extends:nebulaidl.plugins.WorkerGroupSpec)
      com.google.protobuf.MessageOrBuilder {
   ...
   * </pre>
   *
   * Protobuf type {@code nebulaidl.plugins.WorkerGroupSpec}
   */
  public  static final class WorkerGroupSpec extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:nebulaidl.plugins.WorkerGroupSpec)
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_WorkerGroupSpec_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_WorkerGroupSpec_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              nebulaidl.plugins.Ray.WorkerGroupSpec.class, nebulaidl.plugins.Ray.WorkerGroupSpec.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof nebulaidl.plugins.Ray.WorkerGroupSpec)) {
        return super.equals(obj);
      }
      nebulaidl.plugins.Ray.WorkerGroupSpec other = (nebulaidl.plugins.Ray.WorkerGroupSpec) obj;
    ...
    public static nebulaidl.plugins.Ray.WorkerGroupSpec parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static nebulaidl.plugins.Ray.WorkerGroupSpec parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static nebulaidl.plugins.Ray.WorkerGroupSpec parseFrom(
    ...
    public static nebulaidl.plugins.Ray.WorkerGroupSpec parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static nebulaidl.plugins.Ray.WorkerGroupSpec parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static nebulaidl.plugins.Ray.WorkerGroupSpec parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(nebulaidl.plugins.Ray.WorkerGroupSpec prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:nebulaidl.plugins.WorkerGroupSpec)
        nebulaidl.plugins.Ray.WorkerGroupSpecOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return nebulaidl.plugins.Ray.internal_static_nebulaidl_plugins_WorkerGroupSpec_descriptor;
      }
      ...
      // Construct using nebulaidl.plugins.Ray.WorkerGroupSpec.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public nebulaidl.plugins.Ray.WorkerGroupSpec getDefaultInstanceForType() {
        return nebulaidl.plugins.Ray.WorkerGroupSpec.getDefaultInstance();
      }

      @java.lang.Override
      public nebulaidl.plugins.Ray.WorkerGroupSpec build() {
        nebulaidl.plugins.Ray.WorkerGroupSpec result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public nebulaidl.plugins.Ray.WorkerGroupSpec buildPartial() {
        nebulaidl.plugins.Ray.WorkerGroupSpec result = new nebulaidl.plugins.Ray.WorkerGroupSpec(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof nebulaidl.plugins.Ray.WorkerGroupSpec) {
          return mergeFrom((nebulaidl.plugins.Ray.WorkerGroupSpec)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(nebulaidl.plugins.Ray.WorkerGroupSpec other) {
        if (other == nebulaidl.plugins.Ray.WorkerGroupSpec.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        nebulaidl.plugins.Ray.WorkerGroupSpec parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (nebulaidl.plugins.Ray.WorkerGroupSpec) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
      ...
      // @@protoc_insertion_point(builder_scope:nebulaidl.plugins.WorkerGroupSpec)
    }

    // @@protoc_insertion_point(class_scope:nebulaidl.plugins.WorkerGroupSpec)
    private static final nebulaidl.plugins.Ray.WorkerGroupSpec DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new nebulaidl.plugins.Ray.WorkerGroupSpec();
    }

    public static nebulaidl.plugins.Ray.WorkerGroupSpec getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_nebulaidl_plugins_RayJob_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_nebulaidl_plugins_RayJob_fieldAccessorTable;
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_nebulaidl_plugins_RayCluster_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_nebulaidl_plugins_RayCluster_fieldAccessorTable;
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_nebulaidl_plugins_HeadGroupSpec_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_nebulaidl_plugins_HeadGroupSpec_fieldAccessorTable;
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_nebulaidl_plugins_HeadGroupSpec_RayStartParamsEntry_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_nebulaidl_plugins_HeadGroupSpec_RayStartParamsEntry_fieldAccessorTable;
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_nebulaidl_plugins_WorkerGroupSpec_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_nebulaidl_plugins_WorkerGroupSpec_fieldAccessorTable;
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_nebulaidl_plugins_WorkerGroupSpec_RayStartParamsEntry_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_nebulaidl_plugins_WorkerGroupSpec_RayStartParamsEntry_fieldAccessorTable;
  ...
  static {
    ...
    internal_static_nebulaidl_plugins_RayJob_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_nebulaidl_plugins_RayJob_descriptor,
        new java.lang.String[] { "RayCluster", "RuntimeEnv", });
    internal_static_nebulaidl_plugins_RayCluster_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_nebulaidl_plugins_RayCluster_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_nebulaidl_plugins_RayCluster_descriptor,
        new java.lang.String[] { "HeadGroupSpec", "WorkerGroupSpec", });
    internal_static_nebulaidl_plugins_HeadGroupSpec_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_nebulaidl_plugins_HeadGroupSpec_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_nebulaidl_plugins_HeadGroupSpec_descriptor,
        new java.lang.String[] { "RayStartParams", });
    internal_static_nebulaidl_plugins_HeadGroupSpec_RayStartParamsEntry_descriptor =
      internal_static_nebulaidl_plugins_HeadGroupSpec_descriptor.getNestedTypes().get(0);
    internal_static_nebulaidl_plugins_HeadGroupSpec_RayStartParamsEntry_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_nebulaidl_plugins_HeadGroupSpec_RayStartParamsEntry_descriptor,
        new java.lang.String[] { "Key", "Value", });
    internal_static_nebulaidl_plugins_WorkerGroupSpec_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_nebulaidl_plugins_WorkerGroupSpec_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_nebulaidl_plugins_WorkerGroupSpec_descriptor,
        new java.lang.String[] { "GroupName", "Replicas", "MinReplicas", "MaxReplicas", "RayStartParams", });
    internal_static_nebulaidl_plugins_WorkerGroupSpec_RayStartParamsEntry_descriptor =
      internal_static_nebulaidl_plugins_WorkerGroupSpec_descriptor.getNestedTypes().get(0);
    internal_static_nebulaidl_plugins_WorkerGroupSpec_RayStartParamsEntry_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_nebulaidl_plugins_WorkerGroupSpec_RayStartParamsEntry_descriptor,
        new java.lang.String[] { "Key", "Value", });
  }
