...
.. _ref_nebulaidl/admin/cluster_assignment.proto:

nebulaidl/admin/cluster_assignment.proto
==================================================================
...
.. _ref_nebulaidl.admin.ClusterAssignment:
...
.. _ref_nebulaidl/admin/common.proto:

nebulaidl/admin/common.proto
==================================================================
...
.. _ref_nebulaidl.admin.Annotations:
...
.. csv-table:: Annotations type fields
   ...
   "values", ":ref:`ref_nebulaidl.admin.Annotations.ValuesEntry`", "repeated", "Map of custom annotations to be applied to the execution resource."
...
.. _ref_nebulaidl.admin.Annotations.ValuesEntry:
...
.. _ref_nebulaidl.admin.EmailNotification:
...
.. csv-table:: Labels type fields
   ...
   "values", ":ref:`ref_nebulaidl.admin.Labels.ValuesEntry`", "repeated", "Map of custom labels to be applied to the execution resource."
...
.. _ref_nebulaidl.admin.Labels.ValuesEntry:
...
.. _ref_nebulaidl.admin.NamedEntity:

NamedEntity
------------------------------------------------------------------

Encapsulates information common to a NamedEntity, a Nebula resource such as a task,
...
.. csv-table:: NamedEntity type fields
   ...
   "resource_type", ":ref:`ref_nebulaidl.core.ResourceType`", "", "Resource type of the named entity. One of Task, Workflow or LaunchPlan."
   "id", ":ref:`ref_nebulaidl.admin.NamedEntityIdentifier`", "", ""
   "metadata", ":ref:`ref_nebulaidl.admin.NamedEntityMetadata`", "", "Additional metadata around a named entity."
...
.. _ref_nebulaidl.admin.NamedEntityGetRequest:
...
.. csv-table:: NamedEntityGetRequest type fields
   ...
   "resource_type", ":ref:`ref_nebulaidl.core.ResourceType`", "", "Resource type of the metadata to get. One of Task, Workflow or LaunchPlan. +required"
   "id", ":ref:`ref_nebulaidl.admin.NamedEntityIdentifier`", "", "The identifier for the named entity for which to fetch metadata. +required"
...
.. _ref_nebulaidl.admin.NamedEntityIdentifier:

NamedEntityIdentifier
------------------------------------------------------------------

Encapsulation of fields that identifies a Nebula resource.
A Nebula resource can be a task, workflow or launch plan.
...
.. _ref_nebulaidl.admin.NamedEntityIdentifierList:
...
.. csv-table:: NamedEntityIdentifierList type fields
   ...
   "entities", ":ref:`ref_nebulaidl.admin.NamedEntityIdentifier`", "repeated", "A list of identifiers."
...
.. _ref_nebulaidl.admin.NamedEntityIdentifierListRequest:
...
.. csv-table:: NamedEntityIdentifierListRequest type fields
   ...
   "sort_by", ":ref:`ref_nebulaidl.admin.Sort`", "", "Specifies how listed entities should be sorted in the response. +optional"
...
.. _ref_nebulaidl.admin.NamedEntityList:
...
.. csv-table:: NamedEntityList type fields
   ...
   "entities", ":ref:`ref_nebulaidl.admin.NamedEntity`", "repeated", "A list of NamedEntity objects"
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. _ref_nebulaidl.admin.NamedEntityListRequest:
...
.. csv-table:: NamedEntityListRequest type fields
   ...
   "resource_type", ":ref:`ref_nebulaidl.core.ResourceType`", "", "Resource type of the metadata to query. One of Task, Workflow or LaunchPlan. +required"
   "project", ":ref:`ref_string`", "", "Name of the project that contains the identifiers. +required"
...
.. _ref_nebulaidl.admin.NamedEntityMetadata:
...
.. csv-table:: NamedEntityMetadata type fields
   ...
   "state", ":ref:`ref_nebulaidl.admin.NamedEntityState`", "", "Shared state across all version of the entity At this point in time, only workflow entities can have their state archived."
...
.. _ref_nebulaidl.admin.NamedEntityUpdateRequest:
...
.. csv-table:: NamedEntityUpdateRequest type fields
   ...
   "resource_type", ":ref:`ref_nebulaidl.core.ResourceType`", "", "Resource type of the metadata to update +required"
   "id", ":ref:`ref_nebulaidl.admin.NamedEntityIdentifier`", "", "Identifier of the metadata to update +required"
   "metadata", ":ref:`ref_nebulaidl.admin.NamedEntityMetadata`", "", "Metadata object to set as the new value +required"
...
.. _ref_nebulaidl.admin.NamedEntityUpdateResponse:
...
.. _ref_nebulaidl.admin.Notification:

Notification
------------------------------------------------------------------

Represents a structure for notifications based on execution status.
The notification content is configured within nebula admin but can be templatized.
...
.. csv-table:: Notification type fields
   ...
   "phases", ":ref:`ref_nebulaidl.core.WorkflowExecution.Phase`", "repeated", "A list of phases to which users can associate the notifications to. +required"
   "email", ":ref:`ref_nebulaidl.admin.EmailNotification`", "", ""
   "pager_duty", ":ref:`ref_nebulaidl.admin.PagerDutyNotification`", "", ""
   "slack", ":ref:`ref_nebulaidl.admin.SlackNotification`", "", ""
...
.. _ref_nebulaidl.admin.ObjectGetRequest:
...
.. csv-table:: ObjectGetRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "Indicates a unique version of resource. +required"
...
.. _ref_nebulaidl.admin.PagerDutyNotification:
...
.. _ref_nebulaidl.admin.RawOutputDataConfig:

RawOutputDataConfig
------------------------------------------------------------------

Encapsulates user settings pertaining to offloaded data (i.e. Blobs, Schema, query data, etc.).
See https://github.com/nebulaclouds/nebula/issues/211 for more background information.
...
.. _ref_nebulaidl.admin.ResourceListRequest:
...
.. csv-table:: ResourceListRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.admin.NamedEntityIdentifier`", "", "id represents the unique identifier of the resource. +required"
   "limit", ":ref:`ref_uint32`", "", "Indicates the number of resources to be returned. +required"
   ...
   "sort_by", ":ref:`ref_nebulaidl.admin.Sort`", "", "Sort ordering. +optional"
...
.. _ref_nebulaidl.admin.SlackNotification:
...
.. csv-table:: Sort type fields
   ...
   "direction", ":ref:`ref_nebulaidl.admin.Sort.Direction`", "", "Indicates the direction to apply sort key for response values. +optional"
...
.. _ref_nebulaidl.admin.NamedEntityState:
...
.. _ref_nebulaidl.admin.Sort.Direction:
...
.. _ref_nebulaidl/admin/description_entity.proto:

nebulaidl/admin/description_entity.proto
==================================================================
...
.. _ref_nebulaidl.admin.Description:
...
.. csv-table:: Description type fields
   ...
   "format", ":ref:`ref_nebulaidl.admin.DescriptionFormat`", "", "Format of the long description"
...
.. _ref_nebulaidl.admin.DescriptionEntity:
...
.. csv-table:: DescriptionEntity type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "id represents the unique identifier of the description entity."
   "short_description", ":ref:`ref_string`", "", "One-liner overview of the entity."
   "long_description", ":ref:`ref_nebulaidl.admin.Description`", "", "Full user description with formatting preserved."
   "source_code", ":ref:`ref_nebulaidl.admin.SourceCode`", "", "Optional link to source code used to define this entity."
...
.. _ref_nebulaidl.admin.DescriptionEntityList:
...
.. csv-table:: DescriptionEntityList type fields
   ...
   "descriptionEntities", ":ref:`ref_nebulaidl.admin.DescriptionEntity`", "repeated", "A list of DescriptionEntities returned based on the request."
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. _ref_nebulaidl.admin.DescriptionEntityListRequest:
...
.. csv-table:: DescriptionEntityListRequest type fields
   ...
   "resource_type", ":ref:`ref_nebulaidl.core.ResourceType`", "", "Identifies the specific type of resource that this identifier corresponds to."
   "id", ":ref:`ref_nebulaidl.admin.NamedEntityIdentifier`", "", "The identifier for the description entity. +required"
   "limit", ":ref:`ref_uint32`", "", "Indicates the number of resources to be returned. +required"
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. +optional"
   "filters", ":ref:`ref_string`", "", "Indicates a list of filters passed as string. More info on constructing filters : <Link> +optional"
   "sort_by", ":ref:`ref_nebulaidl.admin.Sort`", "", "Sort ordering for returned list. +optional"
...
.. _ref_nebulaidl.admin.SourceCode:
...
.. _ref_nebulaidl.admin.DescriptionFormat:
...
.. _ref_nebulaidl/admin/event.proto:

nebulaidl/admin/event.proto
==================================================================
...
.. _ref_nebulaidl.admin.EventErrorAlreadyInTerminalState:
...
.. _ref_nebulaidl.admin.EventErrorIncompatibleCluster:
...
.. _ref_nebulaidl.admin.EventFailureReason:
...
.. csv-table:: EventFailureReason type fields
   ...
   "already_in_terminal_state", ":ref:`ref_nebulaidl.admin.EventErrorAlreadyInTerminalState`", "", ""
   "incompatible_cluster", ":ref:`ref_nebulaidl.admin.EventErrorIncompatibleCluster`", "", ""
...
.. _ref_nebulaidl.admin.NodeExecutionEventRequest:
...
.. csv-table:: NodeExecutionEventRequest type fields
   ...
   "event", ":ref:`ref_nebulaidl.event.NodeExecutionEvent`", "", "Details about the event that occurred."
...
.. _ref_nebulaidl.admin.NodeExecutionEventResponse:
...
.. _ref_nebulaidl.admin.TaskExecutionEventRequest:
...
.. csv-table:: TaskExecutionEventRequest type fields
   ...
   "request_id", ":ref:`ref_string`", "", "Unique ID for this request that can be traced between services"
   "event", ":ref:`ref_nebulaidl.event.TaskExecutionEvent`", "", "Details about the event that occurred."
...
.. _ref_nebulaidl.admin.TaskExecutionEventResponse:
...
.. _ref_nebulaidl.admin.WorkflowExecutionEventRequest:
...
.. csv-table:: WorkflowExecutionEventRequest type fields
   ...
   "request_id", ":ref:`ref_string`", "", "Unique ID for this request that can be traced between services"
   "event", ":ref:`ref_nebulaidl.event.WorkflowExecutionEvent`", "", "Details about the event that occurred."
...
.. _ref_nebulaidl.admin.WorkflowExecutionEventResponse:
...
.. _ref_nebulaidl/admin/execution.proto:

nebulaidl/admin/execution.proto
==================================================================
...
.. _ref_nebulaidl.admin.AbortMetadata:
...
.. _ref_nebulaidl.admin.Execution:
...
.. csv-table:: Execution type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Unique identifier of the workflow execution."
   "spec", ":ref:`ref_nebulaidl.admin.ExecutionSpec`", "", "User-provided configuration and inputs for launching the execution."
   "closure", ":ref:`ref_nebulaidl.admin.ExecutionClosure`", "", "Execution results."
...
.. _ref_nebulaidl.admin.ExecutionClosure:
...
.. csv-table:: ExecutionClosure type fields
   ...
   "outputs", ":ref:`ref_nebulaidl.admin.LiteralMapBlob`", "", "**Deprecated.** Output URI in the case of a successful execution. DEPRECATED. Use GetExecutionData to fetch output data instead."
   "error", ":ref:`ref_nebulaidl.core.ExecutionError`", "", "Error information in the case of a failed execution."
   "abort_cause", ":ref:`ref_string`", "", "**Deprecated.** In the case of a user-specified abort, this will pass along the user-supplied cause."
   "abort_metadata", ":ref:`ref_nebulaidl.admin.AbortMetadata`", "", "In the case of a user-specified abort, this will pass along the user and their supplied cause."
   "output_data", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "**Deprecated.** Raw output data produced by this execution. DEPRECATED. Use GetExecutionData to fetch output data instead."
   "computed_inputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "**Deprecated.** Inputs computed and passed for execution. computed_inputs depends on inputs in ExecutionSpec, fixed and default inputs in launch plan"
   "phase", ":ref:`ref_nebulaidl.core.WorkflowExecution.Phase`", "", "Most recent recorded phase for the execution."
   ...
   "notifications", ":ref:`ref_nebulaidl.admin.Notification`", "repeated", "The notification settings to use after merging the CreateExecutionRequest and the launch plan notification settings. An execution launched with notifications will always prefer that definition to notifications defined statically in a launch plan."
   "workflow_id", ":ref:`ref_nebulaidl.core.Identifier`", "", "Identifies the workflow definition for this execution."
   "state_change_details", ":ref:`ref_nebulaidl.admin.ExecutionStateChangeDetails`", "", "Provides the details of the last stage change"
...
.. _ref_nebulaidl.admin.ExecutionCreateRequest:
...
.. csv-table:: ExecutionCreateRequest type fields
   ...
   "spec", ":ref:`ref_nebulaidl.admin.ExecutionSpec`", "", "Additional fields necessary to launch the execution. +optional"
   "inputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "The inputs required to start the execution. All required inputs must be included in this map. If not required and not provided, defaults apply. +optional"
...
.. _ref_nebulaidl.admin.ExecutionCreateResponse:
...
.. csv-table:: ExecutionCreateResponse type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", ""
...
.. _ref_nebulaidl.admin.ExecutionList:

ExecutionList
------------------------------------------------------------------

Used as a response for request to list executions.
See :ref:`ref_nebulaidl.admin.Execution` for more details
...
.. csv-table:: ExecutionList type fields
   ...
   "executions", ":ref:`ref_nebulaidl.admin.Execution`", "repeated", ""
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. _ref_nebulaidl.admin.ExecutionMetadata:
...
.. csv-table:: ExecutionMetadata type fields
   ...
   "mode", ":ref:`ref_nebulaidl.admin.ExecutionMetadata.ExecutionMode`", "", ""
   ...
   "parent_node_execution", ":ref:`ref_nebulaidl.core.NodeExecutionIdentifier`", "", "Which subworkflow node (if any) launched this execution"
   "reference_execution", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Optional, a reference workflow execution related to this execution. In the case of a relaunch, this references the original workflow execution."
   "system_metadata", ":ref:`ref_nebulaidl.admin.SystemMetadata`", "", "Optional, platform-specific metadata about the execution. In this the future this may be gated behind an ACL or some sort of authorization."
...
.. _ref_nebulaidl.admin.ExecutionRecoverRequest:
...
.. csv-table:: ExecutionRecoverRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Identifier of the workflow execution to recover."
   ...
   "metadata", ":ref:`ref_nebulaidl.admin.ExecutionMetadata`", "", "Additional metadata which will be used to overwrite any metadata in the reference execution when triggering a recovery execution."
...
.. _ref_nebulaidl.admin.ExecutionRelaunchRequest:
...
.. csv-table:: ExecutionRelaunchRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Identifier of the workflow execution to relaunch. +required"
...
.. _ref_nebulaidl.admin.ExecutionSpec:
...
.. csv-table:: ExecutionSpec type fields
   ...
   "launch_plan", ":ref:`ref_nebulaidl.core.Identifier`", "", "Launch plan to be executed"
   "inputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "**Deprecated.** Input values to be passed for the execution"
   "metadata", ":ref:`ref_nebulaidl.admin.ExecutionMetadata`", "", "Metadata for the execution"
   "notifications", ":ref:`ref_nebulaidl.admin.NotificationList`", "", "List of notifications based on Execution status transitions When this list is not empty it is used rather than any notifications defined in the referenced launch plan. When this list is empty, the notifications defined for the launch plan will be applied."
   "disable_all", ":ref:`ref_bool`", "", "This should be set to true if all notifications are intended to be disabled for this execution."
   "labels", ":ref:`ref_nebulaidl.admin.Labels`", "", "Labels to apply to the execution resource."
   "annotations", ":ref:`ref_nebulaidl.admin.Annotations`", "", "Annotations to apply to the execution resource."
   "security_context", ":ref:`ref_nebulaidl.core.SecurityContext`", "", "Optional: security context override to apply this execution."
   "auth_role", ":ref:`ref_nebulaidl.admin.AuthRole`", "", "**Deprecated.** Optional: auth override to apply this execution."
   "quality_of_service", ":ref:`ref_nebulaidl.core.QualityOfService`", "", "Indicates the runtime priority of the execution."
   ...
   "raw_output_data_config", ":ref:`ref_nebulaidl.admin.RawOutputDataConfig`", "", "User setting to configure where to store offloaded data (i.e. Blobs, structured datasets, query data, etc.). This should be a prefix like s3://my-bucket/my-data"
   "cluster_assignment", ":ref:`ref_nebulaidl.admin.ClusterAssignment`", "", "Controls how to select an available cluster on which this execution should run."
...
.. _ref_nebulaidl.admin.ExecutionStateChangeDetails:
...
.. csv-table:: ExecutionStateChangeDetails type fields
   ...
   "state", ":ref:`ref_nebulaidl.admin.ExecutionState`", "", "The state of the execution is used to control its visibility in the UI/CLI."
...
.. _ref_nebulaidl.admin.ExecutionTerminateRequest:
...
.. csv-table:: ExecutionTerminateRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Uniquely identifies the individual workflow execution to be terminated."
...
.. _ref_nebulaidl.admin.ExecutionTerminateResponse:
...
.. _ref_nebulaidl.admin.ExecutionUpdateRequest:
...
.. csv-table:: ExecutionUpdateRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Identifier of the execution to update"
   "state", ":ref:`ref_nebulaidl.admin.ExecutionState`", "", "State to set as the new value active/archive"
...
.. _ref_nebulaidl.admin.ExecutionUpdateResponse:
...
.. _ref_nebulaidl.admin.LiteralMapBlob:
...
.. csv-table:: LiteralMapBlob type fields
   ...
   "values", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "**Deprecated.** Data in LiteralMap format"
...
.. _ref_nebulaidl.admin.NotificationList:
...
.. csv-table:: NotificationList type fields
   ...
   "notifications", ":ref:`ref_nebulaidl.admin.Notification`", "repeated", ""
...
.. _ref_nebulaidl.admin.SystemMetadata:
...
.. _ref_nebulaidl.admin.WorkflowExecutionGetDataRequest:

WorkflowExecutionGetDataRequest
------------------------------------------------------------------

Request structure to fetch inputs, output and other data produced by an execution.
By default this data is not returned inline in :ref:`ref_nebulaidl.admin.WorkflowExecutionGetRequest`
...
.. csv-table:: WorkflowExecutionGetDataRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "The identifier of the execution for which to fetch inputs and outputs."
...
.. _ref_nebulaidl.admin.WorkflowExecutionGetDataResponse:
...
.. csv-table:: WorkflowExecutionGetDataResponse type fields
   ...
   "outputs", ":ref:`ref_nebulaidl.admin.UrlBlob`", "", "**Deprecated.** Signed url to fetch a core.LiteralMap of execution outputs. Deprecated: Please use full_outputs instead."
   "inputs", ":ref:`ref_nebulaidl.admin.UrlBlob`", "", "**Deprecated.** Signed url to fetch a core.LiteralMap of execution inputs. Deprecated: Please use full_inputs instead."
   "full_inputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Full_inputs will only be populated if they are under a configured size threshold."
   "full_outputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Full_outputs will only be populated if they are under a configured size threshold."
...
.. _ref_nebulaidl.admin.WorkflowExecutionGetRequest:
...
.. csv-table:: WorkflowExecutionGetRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Uniquely identifies an individual workflow execution."
...
.. _ref_nebulaidl.admin.ExecutionMetadata.ExecutionMode:
...
.. _ref_nebulaidl.admin.ExecutionState:
...
.. _ref_nebulaidl/admin/launch_plan.proto:

nebulaidl/admin/launch_plan.proto
==================================================================
...
.. _ref_nebulaidl.admin.ActiveLaunchPlanRequest:
...
.. csv-table:: ActiveLaunchPlanRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.admin.NamedEntityIdentifier`", "", "+required."
...
.. _ref_nebulaidl.admin.LaunchPlan:
...
.. csv-table:: LaunchPlan type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "Uniquely identifies a launch plan entity."
   "spec", ":ref:`ref_nebulaidl.admin.LaunchPlanSpec`", "", "User-provided launch plan details, including reference workflow, inputs and other metadata."
   "closure", ":ref:`ref_nebulaidl.admin.LaunchPlanClosure`", "", "Values computed by the nebula platform after launch plan registration."
...
.. _ref_nebulaidl.admin.LaunchPlanClosure:

LaunchPlanClosure
------------------------------------------------------------------

Values computed by the nebula platform after launch plan registration.
...
.. csv-table:: LaunchPlanClosure type fields
   ...
   "state", ":ref:`ref_nebulaidl.admin.LaunchPlanState`", "", "Indicate the Launch plan state."
   "expected_inputs", ":ref:`ref_nebulaidl.core.ParameterMap`", "", "Indicates the set of inputs expected when creating an execution with the Launch plan"
   "expected_outputs", ":ref:`ref_nebulaidl.core.VariableMap`", "", "Indicates the set of outputs expected to be produced by creating an execution with the Launch plan"
...
.. _ref_nebulaidl.admin.LaunchPlanCreateRequest:
...
.. _ref_nebulaidl.admin.LaunchPlanCreateResponse:
...
.. _ref_nebulaidl.admin.LaunchPlanList:
...
.. csv-table:: LaunchPlanList type fields
   ...
   "launch_plans", ":ref:`ref_nebulaidl.admin.LaunchPlan`", "repeated", ""
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. _ref_nebulaidl.admin.LaunchPlanMetadata:
...
.. csv-table:: LaunchPlanMetadata type fields
   ...
   "schedule", ":ref:`ref_nebulaidl.admin.Schedule`", "", "Schedule to execute the Launch Plan"
   "notifications", ":ref:`ref_nebulaidl.admin.Notification`", "repeated", "List of notifications based on Execution status transitions"
...
.. _ref_nebulaidl.admin.LaunchPlanSpec:
...
.. csv-table:: LaunchPlanSpec type fields
   ...
   "workflow_id", ":ref:`ref_nebulaidl.core.Identifier`", "", "Reference to the Workflow template that the launch plan references"
   "entity_metadata", ":ref:`ref_nebulaidl.admin.LaunchPlanMetadata`", "", "Metadata for the Launch Plan"
   "default_inputs", ":ref:`ref_nebulaidl.core.ParameterMap`", "", "Input values to be passed for the execution. These can be overridden when an execution is created with this launch plan."
   "fixed_inputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Fixed, non-overridable inputs for the Launch Plan. These can not be overridden when an execution is created with this launch plan."
   "role", ":ref:`ref_string`", "", "**Deprecated.** String to indicate the role to use to execute the workflow underneath"
   "labels", ":ref:`ref_nebulaidl.admin.Labels`", "", "Custom labels to be applied to the execution resource."
   "annotations", ":ref:`ref_nebulaidl.admin.Annotations`", "", "Custom annotations to be applied to the execution resource."
   "auth", ":ref:`ref_nebulaidl.admin.Auth`", "", "**Deprecated.** Indicates the permission associated with workflow executions triggered with this launch plan."
   "auth_role", ":ref:`ref_nebulaidl.admin.AuthRole`", "", "**Deprecated.** "
   "security_context", ":ref:`ref_nebulaidl.core.SecurityContext`", "", "Indicates security context for permissions triggered with this launch plan"
   "quality_of_service", ":ref:`ref_nebulaidl.core.QualityOfService`", "", "Indicates the runtime priority of the execution."
   "raw_output_data_config", ":ref:`ref_nebulaidl.admin.RawOutputDataConfig`", "", "Encapsulates user settings pertaining to offloaded data (i.e. Blobs, Schema, query data, etc.)."
...
.. _ref_nebulaidl.admin.LaunchPlanUpdateRequest:
...
.. csv-table:: LaunchPlanUpdateRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "Identifier of launch plan for which to change state. +required."
   "state", ":ref:`ref_nebulaidl.admin.LaunchPlanState`", "", "Desired state to apply to the launch plan. +required."
...
.. _ref_nebulaidl.admin.LaunchPlanUpdateResponse:
...
.. _ref_nebulaidl.admin.LaunchPlanState:
...
.. _ref_nebulaidl/admin/matchable_resource.proto:

nebulaidl/admin/matchable_resource.proto
==================================================================
...
.. _ref_nebulaidl.admin.ClusterResourceAttributes:
...
.. csv-table:: ClusterResourceAttributes type fields
   ...
   "attributes", ":ref:`ref_nebulaidl.admin.ClusterResourceAttributes.AttributesEntry`", "repeated", "Custom resource attributes which will be applied in cluster resource creation (e.g. quotas). Map keys are the *case-sensitive* names of variables in templatized resource files. Map values should be the custom values which get substituted during resource creation."
...
.. _ref_nebulaidl.admin.ClusterResourceAttributes.AttributesEntry:
...
.. _ref_nebulaidl.admin.ExecutionClusterLabel:
...
.. _ref_nebulaidl.admin.ExecutionQueueAttributes:
...
.. _ref_nebulaidl.admin.ListMatchableAttributesRequest:
...
.. csv-table:: ListMatchableAttributesRequest type fields
   ...
   "resource_type", ":ref:`ref_nebulaidl.admin.MatchableResource`", "", "+required"
...
.. _ref_nebulaidl.admin.ListMatchableAttributesResponse:
...
.. csv-table:: ListMatchableAttributesResponse type fields
   ...
   "configurations", ":ref:`ref_nebulaidl.admin.MatchableAttributesConfiguration`", "repeated", ""
...
.. _ref_nebulaidl.admin.MatchableAttributesConfiguration:
...
.. csv-table:: MatchableAttributesConfiguration type fields
   ...
   "attributes", ":ref:`ref_nebulaidl.admin.MatchingAttributes`", "", ""
...
.. _ref_nebulaidl.admin.MatchingAttributes:
...
.. csv-table:: MatchingAttributes type fields
   ...
   "task_resource_attributes", ":ref:`ref_nebulaidl.admin.TaskResourceAttributes`", "", ""
   "cluster_resource_attributes", ":ref:`ref_nebulaidl.admin.ClusterResourceAttributes`", "", ""
   "execution_queue_attributes", ":ref:`ref_nebulaidl.admin.ExecutionQueueAttributes`", "", ""
   "execution_cluster_label", ":ref:`ref_nebulaidl.admin.ExecutionClusterLabel`", "", ""
   "quality_of_service", ":ref:`ref_nebulaidl.core.QualityOfService`", "", ""
   "plugin_overrides", ":ref:`ref_nebulaidl.admin.PluginOverrides`", "", ""
   "workflow_execution_config", ":ref:`ref_nebulaidl.admin.WorkflowExecutionConfig`", "", ""
   "cluster_assignment", ":ref:`ref_nebulaidl.admin.ClusterAssignment`", "", ""
...
.. _ref_nebulaidl.admin.PluginOverride:
...
.. csv-table:: PluginOverride type fields
   ...
   "missing_plugin_behavior", ":ref:`ref_nebulaidl.admin.PluginOverride.MissingPluginBehavior`", "", "Defines the behavior when no plugin from the plugin_id list is not found."
...
.. _ref_nebulaidl.admin.PluginOverrides:
...
.. csv-table:: PluginOverrides type fields
   ...
   "overrides", ":ref:`ref_nebulaidl.admin.PluginOverride`", "repeated", ""
...
.. _ref_nebulaidl.admin.TaskResourceAttributes:
...
.. csv-table:: TaskResourceAttributes type fields
   ...
   "defaults", ":ref:`ref_nebulaidl.admin.TaskResourceSpec`", "", ""
   "limits", ":ref:`ref_nebulaidl.admin.TaskResourceSpec`", "", ""
...
.. _ref_nebulaidl.admin.TaskResourceSpec:
...
.. _ref_nebulaidl.admin.WorkflowExecutionConfig:
...
.. csv-table:: WorkflowExecutionConfig type fields
   ...
   "security_context", ":ref:`ref_nebulaidl.core.SecurityContext`", "", "Indicates security context permissions for executions triggered with this matchable attribute."
   "raw_output_data_config", ":ref:`ref_nebulaidl.admin.RawOutputDataConfig`", "", "Encapsulates user settings pertaining to offloaded data (i.e. Blobs, Schema, query data, etc.)."
   "labels", ":ref:`ref_nebulaidl.admin.Labels`", "", "Custom labels to be applied to a triggered execution resource."
   "annotations", ":ref:`ref_nebulaidl.admin.Annotations`", "", "Custom annotations to be applied to a triggered execution resource."
   "interruptible", ":ref:`ref_google.protobuf.BoolValue`", "", "Allows for the interruptible flag of a workflow to be overwritten for a single execution. Omitting this field uses the workflow's value as a default. As we need to distinguish between the field not being provided and its default value false, we have to use a wrapper around the bool field."
   "overwrite_cache", ":ref:`ref_bool`", "", "Allows for all cached values of a workflow and its tasks to be overwritten for a single execution. If enabled, all calculations are performed even if cached results would be available, overwriting the stored data once execution finishes successfully."
...
.. _ref_nebulaidl.admin.MatchableResource:
...
.. _ref_nebulaidl.admin.PluginOverride.MissingPluginBehavior:
...
.. csv-table:: Enum PluginOverride.MissingPluginBehavior values
   ...
   "FAIL", "0", "By default, if this plugin is not enabled for a Nebula deployment then execution will fail."
...
.. _ref_nebulaidl/admin/node_execution.proto:

nebulaidl/admin/node_execution.proto
==================================================================
...
.. _ref_nebulaidl.admin.DynamicWorkflowNodeMetadata:
...
.. csv-table:: DynamicWorkflowNodeMetadata type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "id represents the unique identifier of the workflow."
   "compiled_workflow", ":ref:`ref_nebulaidl.core.CompiledWorkflowClosure`", "", "Represents the compiled representation of the embedded dynamic workflow."
...
.. _ref_nebulaidl.admin.NodeExecution:
...
.. csv-table:: NodeExecution type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.NodeExecutionIdentifier`", "", "Uniquely identifies an individual node execution."
   "input_uri", ":ref:`ref_string`", "", "Path to remote data store where input blob is stored."
   "closure", ":ref:`ref_nebulaidl.admin.NodeExecutionClosure`", "", "Computed results associated with this node execution."
   "metadata", ":ref:`ref_nebulaidl.admin.NodeExecutionMetaData`", "", "Metadata for Node Execution"
...
.. _ref_nebulaidl.admin.NodeExecutionClosure:
...
.. csv-table:: NodeExecutionClosure type fields
   ...
   "error", ":ref:`ref_nebulaidl.core.ExecutionError`", "", "Error information for the Node"
   "output_data", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "**Deprecated.** Raw output data produced by this node execution. DEPRECATED. Use GetNodeExecutionData to fetch output data instead."
   "phase", ":ref:`ref_nebulaidl.core.NodeExecution.Phase`", "", "The last recorded phase for this node execution."
   ...
   "workflow_node_metadata", ":ref:`ref_nebulaidl.admin.WorkflowNodeMetadata`", "", ""
   "task_node_metadata", ":ref:`ref_nebulaidl.admin.TaskNodeMetadata`", "", ""
...
.. _ref_nebulaidl.admin.NodeExecutionForTaskListRequest:
...
.. csv-table:: NodeExecutionForTaskListRequest type fields
   ...
   "task_execution_id", ":ref:`ref_nebulaidl.core.TaskExecutionIdentifier`", "", "Indicates the node execution to filter by. +required"
   "limit", ":ref:`ref_uint32`", "", "Indicates the number of resources to be returned. +required"
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the, server-provided token can be used to fetch the next page in a query. +optional"
   "filters", ":ref:`ref_string`", "", "Indicates a list of filters passed as string. More info on constructing filters : <Link> +optional"
   "sort_by", ":ref:`ref_nebulaidl.admin.Sort`", "", "Sort ordering. +optional"
...
.. _ref_nebulaidl.admin.NodeExecutionGetDataRequest:

NodeExecutionGetDataRequest
------------------------------------------------------------------

Request structure to fetch inputs and output for a node execution.
By default, these are not returned in :ref:`ref_nebulaidl.admin.NodeExecutionGetRequest`
...
.. csv-table:: NodeExecutionGetDataRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.NodeExecutionIdentifier`", "", "The identifier of the node execution for which to fetch inputs and outputs."
...
.. _ref_nebulaidl.admin.NodeExecutionGetDataResponse:
...
.. csv-table:: NodeExecutionGetDataResponse type fields
   ...
   "inputs", ":ref:`ref_nebulaidl.admin.UrlBlob`", "", "**Deprecated.** Signed url to fetch a core.LiteralMap of node execution inputs. Deprecated: Please use full_inputs instead."
   "outputs", ":ref:`ref_nebulaidl.admin.UrlBlob`", "", "**Deprecated.** Signed url to fetch a core.LiteralMap of node execution outputs. Deprecated: Please use full_outputs instead."
   "full_inputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Full_inputs will only be populated if they are under a configured size threshold."
   "full_outputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Full_outputs will only be populated if they are under a configured size threshold."
   "dynamic_workflow", ":ref:`ref_nebulaidl.admin.DynamicWorkflowNodeMetadata`", "", "Optional Workflow closure for a dynamically generated workflow, in the case this node yields a dynamic workflow we return its structure here."
...
.. _ref_nebulaidl.admin.NodeExecutionGetRequest:

NodeExecutionGetRequest
------------------------------------------------------------------

A message used to fetch a single node execution entity.
See :ref:`ref_nebulaidl.admin.NodeExecution` for more details
...
.. csv-table:: NodeExecutionGetRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.NodeExecutionIdentifier`", "", "Uniquely identifies an individual node execution. +required"
...
.. _ref_nebulaidl.admin.NodeExecutionList:
...
.. csv-table:: NodeExecutionList type fields
   ...
   "node_executions", ":ref:`ref_nebulaidl.admin.NodeExecution`", "repeated", ""
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. _ref_nebulaidl.admin.NodeExecutionListRequest:
...
.. csv-table:: NodeExecutionListRequest type fields
   ...
   "workflow_execution_id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Indicates the workflow execution to filter by. +required"
   "limit", ":ref:`ref_uint32`", "", "Indicates the number of resources to be returned. +required"
...
.. _ref_nebulaidl.admin.NodeExecutionMetaData:
...
.. _ref_nebulaidl.admin.TaskNodeMetadata:
...
.. csv-table:: TaskNodeMetadata type fields
   ...
   "cache_status", ":ref:`ref_nebulaidl.core.CatalogCacheStatus`", "", "Captures the status of caching for this execution."
   "catalog_key", ":ref:`ref_nebulaidl.core.CatalogMetadata`", "", "This structure carries the catalog artifact information"
...
.. _ref_nebulaidl.admin.WorkflowNodeMetadata:
...
.. csv-table:: WorkflowNodeMetadata type fields
   ...
   "executionId", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "The identifier for a workflow execution launched by a node."
...
.. _ref_nebulaidl/admin/notification.proto:

nebulaidl/admin/notification.proto
==================================================================
...
.. _ref_nebulaidl.admin.EmailMessage:
...
.. _ref_nebulaidl/admin/project.proto:

nebulaidl/admin/project.proto
==================================================================
...
.. csv-table:: Project type fields
   ...
   "name", ":ref:`ref_string`", "", "Display name."
   "domains", ":ref:`ref_nebulaidl.admin.Domain`", "repeated", ""
   "description", ":ref:`ref_string`", "", ""
   "labels", ":ref:`ref_nebulaidl.admin.Labels`", "", "Leverage Labels from nebulaidl.admin.common.proto to tag projects with ownership information."
   "state", ":ref:`ref_nebulaidl.admin.Project.ProjectState`", "", ""
...
.. _ref_nebulaidl.admin.ProjectListRequest:
...
.. _ref_nebulaidl.admin.ProjectRegisterRequest:
...
.. csv-table:: ProjectRegisterRequest type fields
   ...
   "project", ":ref:`ref_nebulaidl.admin.Project`", "", "+required"
...
.. _ref_nebulaidl.admin.ProjectRegisterResponse:
...
.. _ref_nebulaidl.admin.ProjectUpdateResponse:
...
.. csv-table:: Projects type fields
   ...
   "projects", ":ref:`ref_nebulaidl.admin.Project`", "repeated", ""
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. _ref_nebulaidl.admin.Project.ProjectState:
...
.. _ref_nebulaidl/admin/project_attributes.proto:

nebulaidl/admin/project_attributes.proto
==================================================================
...
.. _ref_nebulaidl.admin.ProjectAttributes:
...
.. csv-table:: ProjectAttributes type fields
   ...
   "matching_attributes", ":ref:`ref_nebulaidl.admin.MatchingAttributes`", "", ""
...
.. _ref_nebulaidl.admin.ProjectAttributesDeleteRequest:
...
.. csv-table:: ProjectAttributesDeleteRequest type fields
   ...
   "resource_type", ":ref:`ref_nebulaidl.admin.MatchableResource`", "", "Which type of matchable attributes to delete. +required"
...
.. _ref_nebulaidl.admin.ProjectAttributesDeleteResponse:
...
.. _ref_nebulaidl.admin.ProjectAttributesGetRequest:
...
.. csv-table:: ProjectAttributesGetRequest type fields
   ...
   "project", ":ref:`ref_string`", "", "Unique project id which this set of attributes references. +required"
   "resource_type", ":ref:`ref_nebulaidl.admin.MatchableResource`", "", "Which type of matchable attributes to return. +required"
...
.. _ref_nebulaidl.admin.ProjectAttributesGetResponse:
...
.. csv-table:: ProjectAttributesGetResponse type fields
   ...
   "attributes", ":ref:`ref_nebulaidl.admin.ProjectAttributes`", "", ""
...
.. _ref_nebulaidl.admin.ProjectAttributesUpdateRequest:
...
.. csv-table:: ProjectAttributesUpdateRequest type fields
   ...
   "attributes", ":ref:`ref_nebulaidl.admin.ProjectAttributes`", "", "+required"
...
.. _ref_nebulaidl.admin.ProjectAttributesUpdateResponse:
...
.. _ref_nebulaidl/admin/project_domain_attributes.proto:

nebulaidl/admin/project_domain_attributes.proto
==================================================================
...
.. _ref_nebulaidl.admin.ProjectDomainAttributes:
...
.. _ref_nebulaidl.admin.ProjectDomainAttributesDeleteRequest:
...
.. _ref_nebulaidl.admin.ProjectDomainAttributesDeleteResponse:
...
.. _ref_nebulaidl.admin.ProjectDomainAttributesGetRequest:
...
.. _ref_nebulaidl.admin.ProjectDomainAttributesGetResponse:
...
.. csv-table:: ProjectDomainAttributesGetResponse type fields
   ...
   "attributes", ":ref:`ref_nebulaidl.admin.ProjectDomainAttributes`", "", ""
...
.. _ref_nebulaidl.admin.ProjectDomainAttributesUpdateRequest:
...
.. csv-table:: ProjectDomainAttributesUpdateRequest type fields
   ...
   "attributes", ":ref:`ref_nebulaidl.admin.ProjectDomainAttributes`", "", "+required"
...
.. _ref_nebulaidl.admin.ProjectDomainAttributesUpdateResponse:
...
.. _ref_nebulaidl/admin/schedule.proto:

nebulaidl/admin/schedule.proto
==================================================================
...
.. _ref_nebulaidl.admin.CronSchedule:
...
.. _ref_nebulaidl.admin.FixedRate:
...
.. csv-table:: FixedRate type fields
   ...
   "unit", ":ref:`ref_nebulaidl.admin.FixedRateUnit`", "", ""
...
.. csv-table:: Schedule type fields
   ...
   "rate", ":ref:`ref_nebulaidl.admin.FixedRate`", "", ""
   "cron_schedule", ":ref:`ref_nebulaidl.admin.CronSchedule`", "", ""
...
.. _ref_nebulaidl.admin.FixedRateUnit:
...
.. _ref_nebulaidl/admin/signal.proto:

nebulaidl/admin/signal.proto
==================================================================
...
.. csv-table:: Signal type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.SignalIdentifier`", "", "A unique identifier for the requested signal."
   "type", ":ref:`ref_nebulaidl.core.LiteralType`", "", "A type denoting the required value type for this signal."
   "value", ":ref:`ref_nebulaidl.core.Literal`", "", "The value of the signal. This is only available if the signal has been "set" and must match the defined the type."
...
.. _ref_nebulaidl.admin.SignalGetOrCreateRequest:
...
.. _ref_nebulaidl.admin.SignalList:
...
.. csv-table:: SignalList type fields
   ...
   "signals", ":ref:`ref_nebulaidl.admin.Signal`", "repeated", "A list of signals matching the input filters."
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. _ref_nebulaidl.admin.SignalListRequest:
...
.. _ref_nebulaidl.admin.SignalSetRequest:
...
.. csv-table:: SignalSetRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.SignalIdentifier`", "", "A unique identifier for the requested signal."
   "value", ":ref:`ref_nebulaidl.core.Literal`", "", "The value of this signal, must match the defining signal type."
...
.. _ref_nebulaidl.admin.SignalSetResponse:
...
.. _ref_nebulaidl/admin/task.proto:

nebulaidl/admin/task.proto
==================================================================
...
.. csv-table:: Task type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "id represents the unique identifier of the task."
   "closure", ":ref:`ref_nebulaidl.admin.TaskClosure`", "", "closure encapsulates all the fields that maps to a compiled version of the task."
   "short_description", ":ref:`ref_string`", "", "One-liner overview of the entity."
...
.. _ref_nebulaidl.admin.TaskClosure:
...
.. csv-table:: TaskClosure type fields
   ...
   "compiled_task", ":ref:`ref_nebulaidl.core.CompiledTask`", "", "Represents the compiled representation of the task from the specification provided."
...
.. _ref_nebulaidl.admin.TaskCreateRequest:
...
.. csv-table:: TaskCreateRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "id represents the unique identifier of the task. +required"
   "spec", ":ref:`ref_nebulaidl.admin.TaskSpec`", "", "Represents the specification for task. +required"
...
.. _ref_nebulaidl.admin.TaskCreateResponse:
...
.. csv-table:: TaskList type fields
   ...
   "tasks", ":ref:`ref_nebulaidl.admin.Task`", "repeated", "A list of tasks returned based on the request."
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. csv-table:: TaskSpec type fields
   ...
   "template", ":ref:`ref_nebulaidl.core.TaskTemplate`", "", "Template of the task that encapsulates all the metadata of the task."
   "description", ":ref:`ref_nebulaidl.admin.DescriptionEntity`", "", "Represents the specification for description entity."
...
.. _ref_nebulaidl/admin/task_execution.proto:

nebulaidl/admin/task_execution.proto
==================================================================
...
.. _ref_nebulaidl.admin.TaskExecution:
...
.. csv-table:: TaskExecution type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.TaskExecutionIdentifier`", "", "Unique identifier for the task execution."
   "input_uri", ":ref:`ref_string`", "", "Path to remote data store where input blob is stored."
   "closure", ":ref:`ref_nebulaidl.admin.TaskExecutionClosure`", "", "Task execution details and results."
...
.. _ref_nebulaidl.admin.TaskExecutionClosure:
...
.. csv-table:: TaskExecutionClosure type fields
   ...
   "error", ":ref:`ref_nebulaidl.core.ExecutionError`", "", "Error information for the task execution. Populated if the execution failed."
   "output_data", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "**Deprecated.** Raw output data produced by this task execution. DEPRECATED. Use GetTaskExecutionData to fetch output data instead."
   "phase", ":ref:`ref_nebulaidl.core.TaskExecution.Phase`", "", "The last recorded phase for this task execution."
   "logs", ":ref:`ref_nebulaidl.core.TaskLog`", "repeated", "Detailed log information output by the task execution."
   ...
   "task_type", ":ref:`ref_string`", "", "A predefined yet extensible Task type identifier."
   "metadata", ":ref:`ref_nebulaidl.event.TaskExecutionMetadata`", "", "Metadata around how a task was executed."
...
.. _ref_nebulaidl.admin.TaskExecutionGetDataRequest:
...
.. csv-table:: TaskExecutionGetDataRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.TaskExecutionIdentifier`", "", "The identifier of the task execution for which to fetch inputs and outputs. +required"
...
.. _ref_nebulaidl.admin.TaskExecutionGetDataResponse:
...
.. csv-table:: TaskExecutionGetDataResponse type fields
   ...
   "inputs", ":ref:`ref_nebulaidl.admin.UrlBlob`", "", "**Deprecated.** Signed url to fetch a core.LiteralMap of task execution inputs. Deprecated: Please use full_inputs instead."
   "outputs", ":ref:`ref_nebulaidl.admin.UrlBlob`", "", "**Deprecated.** Signed url to fetch a core.LiteralMap of task execution outputs. Deprecated: Please use full_outputs instead."
   "full_inputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Full_inputs will only be populated if they are under a configured size threshold."
   "full_outputs", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Full_outputs will only be populated if they are under a configured size threshold."
...
.. _ref_nebulaidl.admin.TaskExecutionGetRequest:
...
.. csv-table:: TaskExecutionGetRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.TaskExecutionIdentifier`", "", "Unique identifier for the task execution. +required"
...
.. _ref_nebulaidl.admin.TaskExecutionList:
...
.. csv-table:: TaskExecutionList type fields
   ...
   "task_executions", ":ref:`ref_nebulaidl.admin.TaskExecution`", "repeated", ""
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. _ref_nebulaidl.admin.TaskExecutionListRequest:
...
.. csv-table:: TaskExecutionListRequest type fields
   ...
   "node_execution_id", ":ref:`ref_nebulaidl.core.NodeExecutionIdentifier`", "", "Indicates the node execution to filter by. +required"
   "limit", ":ref:`ref_uint32`", "", "Indicates the number of resources to be returned. +required"
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. +optional"
   "filters", ":ref:`ref_string`", "", "Indicates a list of filters passed as string. More info on constructing filters : <Link> +optional"
   "sort_by", ":ref:`ref_nebulaidl.admin.Sort`", "", "Sort ordering for returned list. +optional"
...
.. _ref_nebulaidl/admin/version.proto:

nebulaidl/admin/version.proto
==================================================================
...
.. _ref_nebulaidl.admin.GetVersionRequest:
...
.. _ref_nebulaidl.admin.GetVersionResponse:
...
.. csv-table:: GetVersionResponse type fields
   ...
   "control_plane_version", ":ref:`ref_nebulaidl.admin.Version`", "", "The control plane version information. NebulaAdmin and related components form the control plane of Nebula"
...
.. _ref_nebulaidl/admin/workflow.proto:

nebulaidl/admin/workflow.proto
==================================================================
...
.. _ref_nebulaidl.admin.CreateWorkflowFailureReason:
...
.. csv-table:: CreateWorkflowFailureReason type fields
   ...
   "exists_different_structure", ":ref:`ref_nebulaidl.admin.WorkflowErrorExistsDifferentStructure`", "", ""
   "exists_identical_structure", ":ref:`ref_nebulaidl.admin.WorkflowErrorExistsIdenticalStructure`", "", ""
...
.. csv-table:: Workflow type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "id represents the unique identifier of the workflow."
   "closure", ":ref:`ref_nebulaidl.admin.WorkflowClosure`", "", "closure encapsulates all the fields that maps to a compiled version of the workflow."
   "short_description", ":ref:`ref_string`", "", "One-liner overview of the entity."
...
.. _ref_nebulaidl.admin.WorkflowClosure:
...
.. csv-table:: WorkflowClosure type fields
   ...
   "compiled_workflow", ":ref:`ref_nebulaidl.core.CompiledWorkflowClosure`", "", "Represents the compiled representation of the workflow from the specification provided."
...
.. _ref_nebulaidl.admin.WorkflowCreateRequest:
...
.. csv-table:: WorkflowCreateRequest type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "id represents the unique identifier of the workflow. +required"
   "spec", ":ref:`ref_nebulaidl.admin.WorkflowSpec`", "", "Represents the specification for workflow. +required"
...
.. _ref_nebulaidl.admin.WorkflowCreateResponse:
...
.. _ref_nebulaidl.admin.WorkflowErrorExistsDifferentStructure:
...
.. csv-table:: WorkflowErrorExistsDifferentStructure type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", ""
...
.. _ref_nebulaidl.admin.WorkflowErrorExistsIdenticalStructure:
...
.. _ref_nebulaidl.admin.WorkflowList:
...
.. csv-table:: WorkflowList type fields
   ...
   "workflows", ":ref:`ref_nebulaidl.admin.Workflow`", "repeated", "A list of workflows returned based on the request."
   "token", ":ref:`ref_string`", "", "In the case of multiple pages of results, the server-provided token can be used to fetch the next page in a query. If there are no more results, this value will be empty."
...
.. _ref_nebulaidl.admin.WorkflowSpec:
...
.. csv-table:: WorkflowSpec type fields
   ...
   "template", ":ref:`ref_nebulaidl.core.WorkflowTemplate`", "", "Template of the task that encapsulates all the metadata of the workflow."
   "sub_workflows", ":ref:`ref_nebulaidl.core.WorkflowTemplate`", "repeated", "Workflows that are embedded into other workflows need to be passed alongside the parent workflow to the propeller compiler (since the compiler doesn't have any knowledge of other workflows - ie, it doesn't reach out to Admin to see other registered workflows). In fact, subworkflows do not even need to be registered."
   "description", ":ref:`ref_nebulaidl.admin.DescriptionEntity`", "", "Represents the specification for description entity."
...
.. _ref_nebulaidl/admin/workflow_attributes.proto:

nebulaidl/admin/workflow_attributes.proto
==================================================================
...
.. _ref_nebulaidl.admin.WorkflowAttributes:
...
.. _ref_nebulaidl.admin.WorkflowAttributesDeleteRequest:
...
.. _ref_nebulaidl.admin.WorkflowAttributesDeleteResponse:
...
.. _ref_nebulaidl.admin.WorkflowAttributesGetRequest:
...
.. _ref_nebulaidl.admin.WorkflowAttributesGetResponse:
...
.. csv-table:: WorkflowAttributesGetResponse type fields
   ...
   "attributes", ":ref:`ref_nebulaidl.admin.WorkflowAttributes`", "", ""
...
.. _ref_nebulaidl.admin.WorkflowAttributesUpdateRequest:
...
.. _ref_nebulaidl.admin.WorkflowAttributesUpdateResponse:
