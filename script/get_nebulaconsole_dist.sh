...
NEBULACONSOLE_IMAGE="ghcr.io/nebulaclouds/nebulaconsole:${NEBULACONSOLE_VERSION:-latest}"
IMAGE_DIGEST="$(docker manifest inspect --verbose ${NEBULACONSOLE_IMAGE} | \
...
CONTAINER_ID=$(docker create ghcr.io/nebulaclouds/nebulaconsole:${NEBULACONSOLE_VERSION:-latest})
