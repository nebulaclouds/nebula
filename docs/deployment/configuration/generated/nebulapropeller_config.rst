.. _nebulapropeller-config-specification:
...
Use the same gRPC credentials option as the nebulaadmin client
...
.. code-block:: yaml
  ...
  defaultAgent:
    ...
    defaultTimeout: 10s
    endpoint: dns:///nebulaagent.nebula.svc.cluster.local:80
    insecure: true
    timeouts: null
  resourceConstraints:
...
.. code-block:: yaml
  ...
  databricksInstance: ""
  databricksTokenKey: NEBULA_DATABRICKS_API_TOKEN
...
.. code-block:: yaml
  ...
  lruCacheSize: 2000
  quboleTokenKey: NEBULA_QUBOLE_CLIENT_TOKEN
  workers: 15
...
.. code-block:: yaml
  ...
  resourceConstraints:
    ...
    ProjectScopeResourceConstraint:
      Value: 100
  snowflakeTokenKey: NEBULA_SNOWFLAKE_CLIENT_TOKEN
  webApi:
    caching:
      maxSystemFailures: 5
      resyncInterval: 30s
...
.. code-block:: yaml
  ...
  dns:///nebulaagent.nebula.svc.cluster.local:80
...
The maximum number of transactions per second to nebula admin from this client.
