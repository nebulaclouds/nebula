...
Nebulaidl (Interface Definition Language) is where shared Nebula entities are defined. It also defines the RPC service definition for the :std:ref:`core Nebula API <ref_nebulaidl/service/admin.proto>`.
...
- :ref:`NebulaPropeller <nebulapropeller-architecture>`
- :ref:`Nebula Native Scheduler <native-scheduler-architecture>`

Component Code References
=========================

- `NebulaAdmin <https://pkg.go.dev/mod/github.com/nebulaclouds/nebulaadmin>`__
- `NebulaPropeller <https://pkg.go.dev/mod/github.com/nebulaclouds/nebulapropeller>`__
- `DataCatalog <https://pkg.go.dev/mod/github.com/nebulaclouds/datacatalog>`__
- `NebulaPlugins <https://pkg.go.dev/mod/github.com/nebulaclouds/nebulaplugins>`__
- `Nebula Native Scheduler <https://pkg.go.dev/github.com/nebulaclouds/nebulaadmin/scheduler>`__
