...
For example: We develop and deploy Nebula workflows in development, staging, and production. We configure Nebula domains with those names, and specify lower resource limits on the development and staging domains than production domains.
