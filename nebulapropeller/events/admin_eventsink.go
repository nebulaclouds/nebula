...
import (
	...
	"github.com/nebulaclouds/nebula/nebulapropeller/events/errors"
...
// Constructs a new EventSink that sends events to NebulaAdmin through gRPC
...
// Sends events to the NebulaAdmin service through gRPC
