...
func TestFileEvent(t *testing.T) {
	...
	expected := []string{
		"[--WF EVENT--] project:\"NebulaTest\" domain:\"NebulaStaging\" name:\"Name\" , " +
			"Phase: SUCCEEDED, OccuredAt: " + ptypes.TimestampString(now),
		"[--NODE EVENT--] node_id:\"node1\" execution_id:<project:\"NebulaTest\" " +
			"domain:\"NebulaStaging\" name:\"Name\" > , Phase: RUNNING, OccuredAt: " + ptypes.TimestampString(now),
		"[--TASK EVENT--] resource_type:TASK project:\"NebulaTest\" domain:\"NebulaStaging\" " +
			"name:\"Name\" ,node_id:\"node1\" execution_id:<project:\"NebulaTest\" domain:\"NebulaStaging\" " +
