...
func validateOperand(node c.NodeBuilder, paramName string, operand *nebula.Operand,
	requireParamType bool, errs errors.CompileErrors) (literalType *nebula.LiteralType, ok bool) {
	if operand == nil {
...
func ValidateBooleanExpression(w c.WorkflowBuilder, node c.NodeBuilder, expr *nebula.BooleanExpression, requireParamType bool, errs errors.CompileErrors) (ok bool) {
	if expr == nil {
