...
func TestBuildNebulaWorkflow_withInputs(t *testing.T) {
	w := createSampleMockWorkflow()
...
func TestBuildNebulaWorkflow_withUnionInputs(t *testing.T) {
	w := createSampleMockWorkflow()
...
func TestBuildNebulaWorkflow_withBranch(t *testing.T) {
