...
func buildNodeSpec(n *core.Node, tasks []*core.CompiledTask, errs errors.CompileErrors) ([]*v1alpha1.NodeSpec, bool) {
	...
	res, err := nebulak8s.ToK8sResourceRequirements(resources)
	if err != nil {
