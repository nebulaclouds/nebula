...
import (
	...
	"github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/workflow/errors"
...
func (c *workflowExecutor) constructWorkflowMetadataPrefix(ctx context.Context, w *v1alpha1.NebulaWorkflow) (storage.DataReference, error) {
...
func (c *workflowExecutor) handleReadyWorkflow(ctx context.Context, w *v1alpha1.NebulaWorkflow) (Status, error) {
...
func (c *workflowExecutor) handleRunningWorkflow(ctx context.Context, w *v1alpha1.NebulaWorkflow) (Status, error) {
	startNode := w.StartNode()
	if startNode == nil {
		return StatusFailing(&core.ExecutionError{
			Kind:    core.ExecutionError_SYSTEM,
...
func (c *workflowExecutor) handleFailureNode(ctx context.Context, w *v1alpha1.NebulaWorkflow) (Status, error) {
...
func (c *workflowExecutor) handleFailingWorkflow(ctx context.Context, w *v1alpha1.NebulaWorkflow) (Status, error) {
	execErr := executionErrorOrDefault(w.GetExecutionStatus().GetExecutionError(), w.GetExecutionStatus().GetMessage())
...
func (c *workflowExecutor) handleSucceedingWorkflow(ctx context.Context, w *v1alpha1.NebulaWorkflow) Status {
...
func (c *workflowExecutor) HandleNebulaWorkflow(ctx context.Context, w *v1alpha1.NebulaWorkflow) error {
...
func (c *workflowExecutor) HandleAbortedWorkflow(ctx context.Context, w *v1alpha1.NebulaWorkflow, maxRetries uint32) error {
	w.DataReferenceConstructor = c.store
