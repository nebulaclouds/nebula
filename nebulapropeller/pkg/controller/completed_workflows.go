...
const (
	controllerAgentName          = "nebulaworkflow-controller"
...
func SetCompletedLabel(w *v1alpha1.NebulaWorkflow, currentTime time.Time) {
	if w.Labels == nil {
...
func HasCompletedLabel(w *v1alpha1.NebulaWorkflow) bool {
	if w.Labels != nil {
