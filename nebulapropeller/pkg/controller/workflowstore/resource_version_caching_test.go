...
func TestResourceVersionCaching_Get_NotInCache(t *testing.T) {
	...
	t.Run("notFound", func(t *testing.T) {
		l.GetCb = func(name string) (*v1alpha1.NebulaWorkflow, error) {
			return nil, kubeerrors.NewNotFound(v1alpha1.Resource(v1alpha1.NebulaWorkflowKind), resourceVersionCachingName)
		}
	...
	t.Run("alreadyExists?", func(t *testing.T) {
		l.GetCb = func(name string) (*v1alpha1.NebulaWorkflow, error) {
			return nil, kubeerrors.NewAlreadyExists(v1alpha1.Resource(v1alpha1.NebulaWorkflowKind), resourceVersionCachingName)
		}
		w, err := wfStore.Get(ctx, resourceVersionCachingNamespace, resourceVersionCachingName)
		assert.Error(t, err)
		assert.Nil(t, w)
...
func TestResourceVersionCaching_Get_UpdateAndRead(t *testing.T) {
	...
	mockClient := createFakeClientSet().NebulaworkflowV1alpha1()
