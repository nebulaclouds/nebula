...
func (r *resourceVersionCaching) Get(ctx context.Context, namespace, name string) (*v1alpha1.NebulaWorkflow, error) {
...
func (r *resourceVersionCaching) UpdateStatus(ctx context.Context, workflow *v1alpha1.NebulaWorkflow, priorityClass PriorityClass) (
...
func (r *resourceVersionCaching) Update(ctx context.Context, workflow *v1alpha1.NebulaWorkflow, priorityClass PriorityClass) (
	newWF *v1alpha1.NebulaWorkflow, err error) {
...
func NewResourceVersionCachingStore(_ context.Context, scope promutils.Scope, workflowStore NebulaWorkflow) NebulaWorkflow {
