...
import (
	...
	"github.com/nebulaclouds/nebula/nebulapropeller/pkg/client/clientset/versioned/typed/nebulaworkflow/v1alpha1"
...
type GarbageCollector struct {
	wfClient                  v1alpha1.NebulaworkflowV1alpha1Interface
...
func (g *GarbageCollector) deleteWorkflowsForNamespace(ctx context.Context, namespace string, labelSelector *v1.LabelSelector) error {
	...
	return g.wfClient.NebulaWorkflows(namespace).DeleteCollection(
		ctx,
		v1.DeleteOptions{
...
func NewGarbageCollector(cfg *config.Config, scope promutils.Scope, clk clock.WithTicker, namespaceClient corev1.NamespaceInterface, wfClient v1alpha1.NebulaworkflowV1alpha1Interface) (*GarbageCollector, error) {
	ttl := 23
