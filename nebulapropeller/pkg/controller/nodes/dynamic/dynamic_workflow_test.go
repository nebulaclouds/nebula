...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/encoding"
	...
	mocks2 "github.com/nebulaclouds/nebula/nebulapropeller/pkg/apis/nebulaworkflow/v1alpha1/mocks"
	mocks4 "github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/executors/mocks"
	mocks6 "github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/nodes/dynamic/mocks"
	...
	mocks5 "github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/nodes/subworkflow/launchplan/mocks"
...
func Test_dynamicNodeHandler_buildContextualDynamicWorkflow_withLaunchPlans(t *testing.T) {
	...
	t.Run("dynamic wf cached", func(t *testing.T) {
		...
		// Create a k8s Nebula workflow and store that in the cache
		dynamicWf := &v1alpha1.NebulaWorkflow{
