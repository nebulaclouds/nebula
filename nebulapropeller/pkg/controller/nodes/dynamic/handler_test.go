...
import (
	...
	"github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/nodes/dynamic/mocks"
	...
	lpMocks "github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/nodes/subworkflow/launchplan/mocks"
...
func Test_dynamicNodeHandler_Handle_SubTaskV1(t *testing.T) {
	createNodeContext := func(ttype string, finalOutput storage.DataReference) *nodeMocks.NodeExecutionContext {
		...
		dynamicNS := &nebulaMocks.ExecutableNodeStatus{}
		...
		w := &nebulaMocks.ExecutableWorkflow{}
		ws := &nebulaMocks.ExecutableWorkflowStatus{}
