...
import (
	...
	evtErr "github.com/nebulaclouds/nebula/nebulapropeller/events/errors"
	"github.com/nebulaclouds/nebula/nebulastdlib/cache"
	stdErr "github.com/nebulaclouds/nebula/nebulastdlib/errors"
...
// Executor for Launchplans that executes on a remote NebulaAdmin service (if configured)
...
func NewAdminLaunchPlanExecutor(_ context.Context, client service.AdminServiceClient,
	syncPeriod time.Duration, cfg *AdminConfig, scope promutils.Scope) (NebulaAdmin, error) {
