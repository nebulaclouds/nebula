...
import (
	...
	"github.com/nebulaclouds/nebula/nebulaidl/clients/go/datacatalog/mocks"
...
func TestCatalog_Get(t *testing.T) {
	...
	t.Run("Found w/ tag", func(t *testing.T) {
		...
		mockClient.On("GetArtifact",
			...
			mock.MatchedBy(func(o *datacatalog.GetArtifactRequest) bool {
				assert.EqualValues(t, datasetID, o.Dataset)
				assert.Equal(t, "nebula_cached-BE6CZsMk6N3ExR_4X9EuwBgj2Jh2UwasXK3a_pM9xlY", o.GetTagName())
				return true
			}),
	...
	t.Run("Found w/ tag no inputs or outputs", func(t *testing.T) {
		...
		mockClient.On("GetArtifact",
			...
			mock.MatchedBy(func(o *datacatalog.GetArtifactRequest) bool {
				assert.EqualValues(t, "1.0.0-GKw-c0Pw-GKw-c0Pw", o.Dataset.Version)
				assert.Equal(t, "nebula_cached-GKw-c0PwFokMUQ6T-TUmEWnZ4_VlQ2Qpgw-vCTT0-OQ", o.GetTagName())
				return true
			}),
		).Return(&datacatalog.GetArtifactResponse{Artifact: sampleArtifact}, nil)
...
func TestCatalog_Put(t *testing.T) {
	...
	t.Run("Create new cached execution", func(t *testing.T) {
		...
		mockClient.On("AddTag",
			...
			mock.MatchedBy(func(o *datacatalog.AddTagRequest) bool {
				assert.EqualValues(t, "nebula_cached-BE6CZsMk6N3ExR_4X9EuwBgj2Jh2UwasXK3a_pM9xlY", o.Tag.Name)
				return true
			}),
		...
		assert.Equal(t, "nebula_cached-BE6CZsMk6N3ExR_4X9EuwBgj2Jh2UwasXK3a_pM9xlY", s.GetMetadata().ArtifactTag.Name)
	})
	...
	t.Run("Create new cached execution with no inputs/outputs", func(t *testing.T) {
		...
		mockClient.On("AddTag",
			ctx,
			mock.MatchedBy(func(o *datacatalog.AddTagRequest) bool {
				assert.EqualValues(t, "nebula_cached-GKw-c0PwFokMUQ6T-TUmEWnZ4_VlQ2Qpgw-vCTT0-OQ", o.Tag.Name)
				return true
			}),
		).Return(&datacatalog.AddTagResponse{}, nil)
...
var tagName = "nebula_cached-BE6CZsMk6N3ExR_4X9EuwBgj2Jh2UwasXK3a_pM9xlY"
