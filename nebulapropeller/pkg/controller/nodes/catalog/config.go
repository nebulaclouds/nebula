...
import (
	...
	"github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/nodes/catalog/datacatalog"
...
type Config struct {
	...
	UseAdminAuth bool            `json:"use-admin-auth" pflag:"false, Use the same gRPC credentials option as the nebulaadmin client"`
