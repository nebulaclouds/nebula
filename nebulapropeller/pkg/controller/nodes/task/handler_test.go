...
import (
	...
	pluginCatalogMocks "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/catalog/mocks"
	...
	pluginK8s "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/k8s"
	pluginK8sMocks "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/k8s/mocks"
	...
	nebulaMocks "github.com/nebulaclouds/nebula/nebulapropeller/pkg/apis/nebulaworkflow/v1alpha1/mocks"
	controllerConfig "github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/config"
	"github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/executors/mocks"
	...
	"github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/nodes/task/resourcemanager"
	rmConfig "github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/nodes/task/resourcemanager/config"
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if err == nil {
				...
				if tt.want.checkpoint {
					assert.Equal(t, "s3://sandbox/x/name-n1-1/_nebulacheckpoints",
