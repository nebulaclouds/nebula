...
import (
	...
	pluginCatalog "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/catalog"
...
// ComputeRawOutputPrefix constructs the output directory, where raw outputs of a task can be stored by the task. NebulaPropeller may not have
