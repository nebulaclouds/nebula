...
import (
	...
	pluginscatalog "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/catalog"
	catalogmocks "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/catalog/mocks"
	mocks3 "github.com/nebulaclouds/nebula/nebulaplugins/go/tasks/pluginmachinery/io/mocks"
	...
	mocks4 "github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/executors/mocks"
	...
	storageMocks "github.com/nebulaclouds/nebula/nebulastdlib/storage/mocks"
)
...
func TestSetInputsForStartNode(t *testing.T) {
	...
	exec, err := NewExecutor(ctx, config.GetConfig().NodeConfig, mockStorage, enQWf, eventMocks.NewMockEventSink(), adminClient,
		adminClient, 10, "s3://bucket/", fakeKubeClient, catalogClient, recoveryClient, eventConfig, testClusterID, signalClient, hf, promutils.NewTestScope())
...
func TestNodeExecutor_RecursiveNodeHandler_Cache(t *testing.T) {
	...
	createMockWorkflow := func(currentNodePhase, downstreamNodePhase v1alpha1.NodePhase, dataStore *storage.DataStore) *v1alpha1.NebulaWorkflow {
		return &v1alpha1.NebulaWorkflow{
			Tasks: map[v1alpha1.TaskID]*v1alpha1.TaskSpec{
				taskID: {
					TaskTemplate: &core.TaskTemplate{},
