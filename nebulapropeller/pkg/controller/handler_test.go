...
import (
	...
	eventErrors "github.com/nebulaclouds/nebula/nebulapropeller/events/errors"
	...
	workflowErrors "github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/workflow/errors"
	"github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/workflowstore"
	"github.com/nebulaclouds/nebula/nebulapropeller/pkg/controller/workflowstore/mocks"
...
type mockExecutor struct {
	HandleCb        func(ctx context.Context, w *v1alpha1.NebulaWorkflow) error
	HandleAbortedCb func(ctx context.Context, w *v1alpha1.NebulaWorkflow, maxRetries uint32) error
}
...
func (m *mockExecutor) HandleAbortedWorkflow(ctx context.Context, w *v1alpha1.NebulaWorkflow, maxRetries uint32) error {
	return m.HandleAbortedCb(ctx, w, maxRetries)
}

func (m *mockExecutor) HandleNebulaWorkflow(ctx context.Context, w *v1alpha1.NebulaWorkflow) error {
...
func TestPropeller_Handle(t *testing.T) {
	...
	t.Run("terminated", func(t *testing.T) {
		assert.NoError(t, s.Create(ctx, &v1alpha1.NebulaWorkflow{
			ObjectMeta: v1.ObjectMeta{
				Name:      name,
				Namespace: namespace,
			},
	...
	t.Run("happy", func(t *testing.T) {
		...
		exec.HandleCb = func(ctx context.Context, w *v1alpha1.NebulaWorkflow) error {
	...
	t.Run("abort", func(t *testing.T) {
		...
		exec.HandleAbortedCb = func(ctx context.Context, w *v1alpha1.NebulaWorkflow, maxRetries uint32) error {
