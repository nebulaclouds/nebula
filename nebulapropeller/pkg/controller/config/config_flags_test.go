...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_create-nebulaworkflow-crd", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("create-nebulaworkflow-crd", testValue)
			if vBool, err := cmdFlags.GetBool("create-nebulaworkflow-crd"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vBool), &actual.CreateNebulaWorkflowCRD)
