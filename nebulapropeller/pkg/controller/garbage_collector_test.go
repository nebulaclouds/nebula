...
type mockWfClient struct {
	v1alpha1.NebulaWorkflowInterface
...
type mockClient struct {
	v1alpha1.NebulaworkflowV1alpha1Client
	NebulaWorkflowsCb func(namespace string) v1alpha1.NebulaWorkflowInterface
}

func (m *mockClient) NebulaWorkflows(namespace string) v1alpha1.NebulaWorkflowInterface {
	return m.NebulaWorkflowsCb(namespace)
}
