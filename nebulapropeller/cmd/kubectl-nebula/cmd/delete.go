...
func (d *DeleteOpts) deleteCompletedWorkflows() error {
	...
	return d.nebulaClient.NebulaworkflowV1alpha1().NebulaWorkflows(d.ConfigOverrides.Context.Namespace).DeleteCollection(
		context.TODO(),
...
func (d *DeleteOpts) deleteWorkflow(name string) error {
	p := v1.DeletePropagationBackground
	if err := d.nebulaClient.NebulaworkflowV1alpha1().NebulaWorkflows(d.ConfigOverrides.Context.Namespace).Delete(context.TODO(), name, v1.DeleteOptions{PropagationPolicy: &p}); err != nil {
		return err
	}
	if d.force {
		w, err := d.nebulaClient.NebulaworkflowV1alpha1().NebulaWorkflows(d.ConfigOverrides.Context.Namespace).Get(context.TODO(), name, v1.GetOptions{})
		if err != nil {
			return err
		}
		w.SetFinalizers([]string{})
		if _, err := d.nebulaClient.NebulaworkflowV1alpha1().NebulaWorkflows(d.ConfigOverrides.Context.Namespace).Update(context.TODO(), w, v1.UpdateOptions{}); err != nil {
			return err
		}
	}
	return nil
