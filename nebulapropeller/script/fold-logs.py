...
class Block(ABC):
    ...
    def parse(self):
        while True:
            ...
            global enqueue_msgs
            # match gcp   {"data":{"src":"controller.go:156"},"message":"==\u003e Enqueueing workflow [nebulasnacks-development/a4f8dxddvnfrfs6jr9nx-n0-0]","severity":"INFO","timestamp":"2022-05-03T09:28:01Z"}
            # match other {"level":"debug", "msg":"Enqueueing owner for updated object [nebulasnacks-development/a4f8dxddvnfrfs6jr9nx-n0-0]"}
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("path", help="path to NebulaPropeller log dump")
